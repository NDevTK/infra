...
func (r *genTraingData) openCsv() error {
	...
	if outfile == "" {
		...
		fmt.Fprintf(r.file, "ResultId,TestName,TestId,FileName,VariantHash,SixMonthRunCount,SixMonthFailRate,OneMonthRunCount,OneMonthFailRate,OneWeekRunCount,OneWeekFailRate,Distance,UseDistance,Failed,\n")
	} else {
