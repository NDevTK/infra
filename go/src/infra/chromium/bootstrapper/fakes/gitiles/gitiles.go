...
type Revision struct {
	...
	//
	// For all commits except the initial commit, missing keys will have the
	// same contents as in the parent commit. For the initial commit, a
	// missing key indicates the file does not exist at the revision. A nil
	// value indicates the file does not exist at the revision.
