...
func (*AssignIdleWorker) Descriptor() ([]byte, []int) {
	return fileDescriptor_mutaters_15469833ff41cbca, []int{0}
}
...
func (*ChangePriority) Descriptor() ([]byte, []int) {
	return fileDescriptor_mutaters_15469833ff41cbca, []int{1}
}
...
func (*PreemptTask) Descriptor() ([]byte, []int) {
	return fileDescriptor_mutaters_15469833ff41cbca, []int{2}
}
...
func init() {
	proto.RegisterFile("infra/qscheduler/qslib/mutaters/mutaters.proto", fileDescriptor_mutaters_15469833ff41cbca)
}

var fileDescriptor_mutaters_15469833ff41cbca = []byte{
