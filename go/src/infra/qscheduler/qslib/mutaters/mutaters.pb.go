...
func (*AssignIdleWorker) Descriptor() ([]byte, []int) {
	return fileDescriptor_mutaters_a770dbf4a41df0a3, []int{0}
}
...
func (*ChangePriority) Descriptor() ([]byte, []int) {
	return fileDescriptor_mutaters_a770dbf4a41df0a3, []int{1}
}
...
func (*PreemptTask) Descriptor() ([]byte, []int) {
	return fileDescriptor_mutaters_a770dbf4a41df0a3, []int{2}
}
...
func init() {
	proto.RegisterFile("infra/qscheduler/qslib/mutaters/mutaters.proto", fileDescriptor_mutaters_a770dbf4a41df0a3)
}

var fileDescriptor_mutaters_a770dbf4a41df0a3 = []byte{
