...
func (*AssignIdleWorker) Descriptor() ([]byte, []int) {
	return fileDescriptor_mutaters_2591548ebb18680b, []int{0}
}
...
func (*ChangePriority) Descriptor() ([]byte, []int) {
	return fileDescriptor_mutaters_2591548ebb18680b, []int{1}
}
...
func (*PreemptTask) Descriptor() ([]byte, []int) {
	return fileDescriptor_mutaters_2591548ebb18680b, []int{2}
}
...
func init() {
	proto.RegisterFile("infra/qscheduler/qslib/mutaters/mutaters.proto", fileDescriptor_mutaters_2591548ebb18680b)
}

var fileDescriptor_mutaters_2591548ebb18680b = []byte{
