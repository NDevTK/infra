...
// fakeScheduler is an implementation of the Scheduler interface, reaps
// according to whatever assingments are provided by MockSchedule.
type fakeScheduler struct {
	// assignments is a map from worker ID the scheduler.Assignment that will
