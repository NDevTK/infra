...
// which demotes some jobs (selected from candidates).
...
// dpPromote is a helper function use by reprioritizeRunningTasks
// which promotes some jobs (selected from candidates).
