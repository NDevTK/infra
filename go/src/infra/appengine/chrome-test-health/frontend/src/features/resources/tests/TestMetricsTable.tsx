  ...
  function constructColumns() {
    ...
    if (params.timelineView) {
      ...
      const columns: [SortType, MetricType, string, (val:any) => string, string][] = [
        [SortType.SORT_NUM_RUNS, MetricType.NUM_RUNS, '# Runs', formatNumber, 'How many times a test was run.'],
        [SortType.SORT_NUM_FAILURES, MetricType.NUM_FAILURES, '# Failures', formatNumber, 'How many times the test failed.'],
        [SortType.SORT_AVG_RUNTIME, MetricType.AVG_RUNTIME, 'Avg Runtime', formatTime, 'Average runtime for a single run of a test.'],
        ...
        [SortType.SORT_AVG_CORES, MetricType.AVG_CORES, 'Avg Cores', formatNumber, 'Total time normalized on time.'],
      ];
