...
const (
	...
	nobodyOncallBody    = `Nobody is on-call for {{.RotaName}} between {{.ShiftEntry.StartTime}} to {{.ShiftEntry.EndTime}}.

	Previously member(s): {{.ShiftEntry.OnCall}} was scheduled to be on call.

	Follow <a href="https://rota-ng.appspot.com/manageshifts?name={{.RotaName}}">link</a> to manage shifts.

	This mail was automatically generated by https://rota-ng.appspot.com to the owners of rotation {{.RotaName}}.
`
)
