...
type TestVariantFailureRateAnalysis struct {
	...
	// of weekday data, whichever is less).
	//
	...
	//    (fail-open).
	//
	// The example criteria limits false exoneration occurrences to an average
	// of 1 CL per year, assuming:
	// - a bad CL (CL that actually breaks a given test) rate of 0.1%,
	// - 1,000 CLs tested per day,
	// - 1,000,000 tests run per CL
	// It results in ~5 CLs incorrectly not exonerated per deterministic test
	// breakage (plus more depending on ingestion latency), absent other
	...
	// flaky tests, over a period including the last 24 hours worth of
	// weekday data (in UTC), or last 1000 verdicts, whichever is less.
	//
...
type VerdictExample struct {
	...
	Changelist []*Changelist `protobuf:"bytes,3,rep,name=changelist,proto3" json:"changelist,omitempty"`
}
...
func (x *VerdictExample) GetChangelist() []*Changelist {
	if x != nil {
		return x.Changelist
	}
	return nil
...
var file_infra_appengine_weetbix_proto_v1_test_variants_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x73, 0x22, 0xa0, 0x03, 0x0a, 0x1e, 0x54, 0x65, 0x73, 0x74,
	...
	0x63, 0x74, 0x45, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x22, 0x53, 0x0a, 0x11, 0x46, 0x6c,
	0x61, 0x6b, 0x79, 0x56, 0x65, 0x72, 0x64, 0x69, 0x63, 0x74, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x12,
	...
	0x51, 0x0a, 0x0f, 0x46, 0x61, 0x69, 0x6c, 0x69, 0x6e, 0x67, 0x52, 0x75, 0x6e, 0x52, 0x61, 0x74,
	0x69, 0x6f, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x75, 0x6d, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x6e, 0x75, 0x6d, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72,
	0x12, 0x20, 0x0a, 0x0b, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x69, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x69, 0x6e, 0x61, 0x74,
	0x6f, 0x72, 0x22, 0xc1, 0x01, 0x0a, 0x0e, 0x56, 0x65, 0x72, 0x64, 0x69, 0x63, 0x74, 0x45, 0x78,
	0x61, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x41, 0x0a, 0x0e, 0x70, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x34, 0x0a, 0x16, 0x69, 0x6e, 0x67, 0x65,
	0x73, 0x74, 0x65, 0x64, 0x5f, 0x69, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x14, 0x69, 0x6e, 0x67, 0x65, 0x73, 0x74,
	0x65, 0x64, 0x49, 0x6e, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x36,
	0x0a, 0x0a, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03,
	...
	0x67, 0x65, 0x6c, 0x69, 0x73, 0x74, 0x32, 0x85, 0x01, 0x0a, 0x0c, 0x54, 0x65, 0x73, 0x74, 0x56,
	0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x73, 0x12, 0x75, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79,
	0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x52, 0x61, 0x74, 0x65, 0x12, 0x2e, 0x2e, 0x77, 0x65,
	...
	0x52, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2f, 0x2e, 0x77, 0x65,
	0x65, 0x74, 0x62, 0x69, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x54, 0x65,
	0x73, 0x74, 0x56, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65,
	0x52, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x2c,
...
var file_infra_appengine_weetbix_proto_v1_test_variants_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_infra_appengine_weetbix_proto_v1_test_variants_proto_goTypes = []interface{}{
	...
	(*Changelist)(nil),                          // 9: weetbix.v1.Changelist
}
var file_infra_appengine_weetbix_proto_v1_test_variants_proto_depIdxs = []int32{
	...
	7,  // 1: weetbix.v1.TestVariantIdentifier.variant:type_name -> weetbix.v1.Variant
	3,  // 2: weetbix.v1.QueryTestVariantFailureRateResponse.test_variants:type_name -> weetbix.v1.TestVariantFailureRateAnalysis
	7,  // 3: weetbix.v1.TestVariantFailureRateAnalysis.variant:type_name -> weetbix.v1.Variant
	...
	8,  // 8: weetbix.v1.VerdictExample.partition_time:type_name -> google.protobuf.Timestamp
	9,  // 9: weetbix.v1.VerdictExample.changelist:type_name -> weetbix.v1.Changelist
	0,  // 10: weetbix.v1.TestVariants.QueryFailureRate:input_type -> weetbix.v1.QueryTestVariantFailureRateRequest
	2,  // 11: weetbix.v1.TestVariants.QueryFailureRate:output_type -> weetbix.v1.QueryTestVariantFailureRateResponse
