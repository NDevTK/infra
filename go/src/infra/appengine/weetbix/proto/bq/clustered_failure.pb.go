...
// 	protoc        v3.17.3
// source: infra/appengine/weetbix/proto/bq/clustered_failure.proto
...
// ClusteredFailure represents a row in a BigQuery table for a clustered test
// failure.
type ClusteredFailure struct {
	...
	// Last Updated defines the version of test result-clusterion inclusion
	// status represented by this row. During its lifetime, due to changing
	...
	// test_result_system, test_result_id) quadruple with a later last_updated
	...
	// rows with the last last_updated time.
	...
	// partition time.
	RootInvocationId string `protobuf:"bytes,21,opt,name=root_invocation_id,json=rootInvocationId,proto3" json:"root_invocation_id,omitempty"`
	...
	RootInvocationResultIndex int64 `protobuf:"varint,22,opt,name=root_invocation_result_index,json=rootInvocationResultIndex,proto3" json:"root_invocation_result_index,omitempty"`
	// The number of test results having this test variant and root
	// invocation.
	RootInvocationResultCount int64 `protobuf:"varint,23,opt,name=root_invocation_result_count,json=rootInvocationResultCount,proto3" json:"root_invocation_result_count,omitempty"`
	...
	// (in the root invocation) are unexpected failures.
	//
	...
	IsRootInvocationBlocked bool `protobuf:"varint,24,opt,name=is_root_invocation_blocked,json=isRootInvocationBlocked,proto3" json:"is_root_invocation_blocked,omitempty"`
...
func (x *ClusteredFailure) Reset() {
	*x = ClusteredFailure{}
	if protoimpl.UnsafeEnabled {
		mi := &file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ClusteredFailure) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClusteredFailure) ProtoMessage() {}

func (x *ClusteredFailure) ProtoReflect() protoreflect.Message {
	mi := &file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_msgTypes[0]
...
// Deprecated: Use ClusteredFailure.ProtoReflect.Descriptor instead.
func (*ClusteredFailure) Descriptor() ([]byte, []int) {
	return file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDescGZIP(), []int{0}
}

func (x *ClusteredFailure) GetClusterAlgorithm() string {
	if x != nil {
...
func (x *ClusteredFailure) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
func (x *ClusteredFailure) GetTestResultSystem() string {
	if x != nil {
...
func (x *ClusteredFailure) GetTestResultId() string {
	if x != nil {
...
func (x *ClusteredFailure) GetLastUpdated() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ClusteredFailure) GetPartitionTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ClusteredFailure) GetIsIncluded() bool {
	if x != nil {
		return x.IsIncluded
	}
	return false
...
func (x *ClusteredFailure) GetIsIncludedWithHighPriority() bool {
	if x != nil {
...
func (x *ClusteredFailure) GetChunkId() string {
	if x != nil {
		return x.ChunkId
	}
	return ""
...
func (x *ClusteredFailure) GetChunkIndex() int64 {
	if x != nil {
		return x.ChunkIndex
	}
	return 0
...
func (x *ClusteredFailure) GetRealm() string {
	if x != nil {
		return x.Realm
	}
	return ""
...
func (x *ClusteredFailure) GetTestId() string {
	if x != nil {
		return x.TestId
	}
	return ""
...
func (x *ClusteredFailure) GetVariant() []*v1.StringPair {
	if x != nil {
		return x.Variant
	}
	return nil
...
func (x *ClusteredFailure) GetVariantHash() string {
	if x != nil {
...
func (x *ClusteredFailure) GetFailureReason() *v1.FailureReason {
	if x != nil {
...
func (x *ClusteredFailure) GetBugTrackingComponent() *v1.BugTrackingComponent {
	if x != nil {
...
func (x *ClusteredFailure) GetStartTime() *timestamppb.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *ClusteredFailure) GetDuration() *durationpb.Duration {
	if x != nil {
		return x.Duration
	}
	return nil
...
func (x *ClusteredFailure) GetIsExonerated() bool {
	if x != nil {
...
func (x *ClusteredFailure) GetPresubmitRunId() *v1.PresubmitRunId {
	if x != nil {
...
func (x *ClusteredFailure) GetRootInvocationId() string {
	if x != nil {
...
func (x *ClusteredFailure) GetRootInvocationResultIndex() int64 {
	if x != nil {
...
func (x *ClusteredFailure) GetRootInvocationResultCount() int64 {
	if x != nil {
...
func (x *ClusteredFailure) GetIsRootInvocationBlocked() bool {
	if x != nil {
...
func (x *ClusteredFailure) GetTestRunId() string {
	if x != nil {
		return x.TestRunId
	}
	return ""
...
func (x *ClusteredFailure) GetTestRunResultIndex() int64 {
	if x != nil {
...
func (x *ClusteredFailure) GetTestRunResultCount() int64 {
	if x != nil {
...
func (x *ClusteredFailure) GetIsTestRunBlocked() bool {
	if x != nil {
...
var File_infra_appengine_weetbix_proto_bq_clustered_failure_proto protoreflect.FileDescriptor

var file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x77, 0x65, 0x65, 0x74,
	0x62, 0x69, 0x78, 0x2e, 0x62, 0x71, 0x1a, 0x1e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d,
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2d, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x2f, 0x61,
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x35, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x2f, 0x61, 0x70,
	...
	0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf2, 0x0a,
	0x0a, 0x10, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x65, 0x64, 0x46, 0x61, 0x69, 0x6c, 0x75,
	0x72, 0x65, 0x12, 0x2b, 0x0a, 0x11, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x61, 0x6c,
	0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x63,
	0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x41, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x12,
	...
	0x0a, 0x12, 0x74, 0x65, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x5f, 0x73, 0x79,
	0x73, 0x74, 0x65, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x74, 0x65, 0x73, 0x74,
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x12, 0x24, 0x0a, 0x0e,
	0x74, 0x65, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x04,
	...
	,
	...
	,
	...
	0x0a, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x12, 0x20, 0x01, 0x28, 0x0b,
	...
	0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x18, 0x13, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x69, 0x73,
	0x45, 0x78, 0x6f, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x12, 0x44, 0x0a, 0x10, 0x70, 0x72,
	0x65, 0x73, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x5f, 0x72, 0x75, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x14,
	...
	,
	...
	0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x12, 0x74, 0x65,
	...
	0x75, 0x6c, 0x74, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x1b, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x75, 0x6e, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x18, 0x1c, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x10, 0x69, 0x73, 0x54, 0x65, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	0x65, 0x64, 0x42, 0x2c, 0x5a, 0x2a, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x2f, 0x61, 0x70, 0x70, 0x65,
	0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2f, 0x77, 0x65, 0x65, 0x74, 0x62, 0x69, 0x78, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2f, 0x62, 0x71, 0x3b, 0x77, 0x65, 0x65, 0x74, 0x62, 0x69, 0x78, 0x70, 0x62,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDescOnce sync.Once
	file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDescData = file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDesc
)

func file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDescGZIP() []byte {
	file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDescOnce.Do(func() {
		file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDescData = protoimpl.X.CompressGZIP(file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDescData)
	})
	return file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDescData
}

var file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_goTypes = []interface{}{
	(*ClusteredFailure)(nil),        // 0: weetbix.bq.ClusteredFailure
...
var file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_depIdxs = []int32{
	1, // 0: weetbix.bq.ClusteredFailure.last_updated:type_name -> google.protobuf.Timestamp
	1, // 1: weetbix.bq.ClusteredFailure.partition_time:type_name -> google.protobuf.Timestamp
	2, // 2: weetbix.bq.ClusteredFailure.variant:type_name -> weetbix.v1.StringPair
	3, // 3: weetbix.bq.ClusteredFailure.failure_reason:type_name -> weetbix.v1.FailureReason
	4, // 4: weetbix.bq.ClusteredFailure.bug_tracking_component:type_name -> weetbix.v1.BugTrackingComponent
	1, // 5: weetbix.bq.ClusteredFailure.start_time:type_name -> google.protobuf.Timestamp
	5, // 6: weetbix.bq.ClusteredFailure.duration:type_name -> google.protobuf.Duration
	6, // 7: weetbix.bq.ClusteredFailure.presubmit_run_id:type_name -> weetbix.v1.PresubmitRunId
...
func init() { file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_init() }
func file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_init() {
	if File_infra_appengine_weetbix_proto_bq_clustered_failure_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ClusteredFailure); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_goTypes,
		DependencyIndexes: file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_depIdxs,
		MessageInfos:      file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_msgTypes,
	}.Build()
	File_infra_appengine_weetbix_proto_bq_clustered_failure_proto = out.File
	file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_rawDesc = nil
	file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_goTypes = nil
	file_infra_appengine_weetbix_proto_bq_clustered_failure_proto_depIdxs = nil
}
