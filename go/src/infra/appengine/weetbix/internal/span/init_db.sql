...
CREATE TABLE ClusteringState (
  ...
  -- versions of a single algorithm, e.g.: v1 -> {reason-0.1}, v2 -> {reason-0.1,
  ...
  -- results in this chunk. This is the RulesLastUpdated time of the most
  ...
  -- The Spanner commit timestamp of the last time the row was updated.
  LastUpdated TIMESTAMP NOT NULL OPTIONS (allow_commit_timestamp=true),
) PRIMARY KEY (ChunkId, Project);
