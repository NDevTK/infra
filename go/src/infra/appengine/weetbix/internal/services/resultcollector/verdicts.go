...
func deriveVerdictStatus(tv *rdbpb.TestVariant) common.VerdictStatus {
	switch tv.Status {
	case rdbpb.TestVariantStatus_FLAKY:
		return common.VerdictStatus_VERDICT_FLAKY
	case rdbpb.TestVariantStatus_EXPECTED:
		return common.VerdictStatus_EXPECTED
	case rdbpb.TestVariantStatus_UNEXPECTED:
		return common.VerdictStatus_UNEXPECTED
