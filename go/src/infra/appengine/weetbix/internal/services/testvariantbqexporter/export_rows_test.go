...
func TestQueryTestVariantsToExport(t *testing.T) {
	Convey(`queryTestVariantsToExport`, t, func() {
		...
		ms := []*spanner.Mutation{
			...
			insert.Verdict(realm, tID1, vh, "build-0", common.VerdictStatus_EXPECTED, twoAndHalfHAgo, map[string]interface{}{
				"IngestionTime":         oneAndHalfHAgo,
				"UnexpectedResultCount": 0,
				"TotalResultCount":      1,
			}),
			insert.Verdict(realm, tID1, vh, "build-1", common.VerdictStatus_VERDICT_FLAKY, twoAndHalfHAgo, map[string]interface{}{
				"IngestionTime":         halfHAgo,
				"UnexpectedResultCount": 1,
				"TotalResultCount":      2,
			}),
			insert.Verdict(realm, tID1, vh, "build-2", common.VerdictStatus_EXPECTED, oneAndHalfHAgo, map[string]interface{}{
				"IngestionTime":         halfHAgo,
				"UnexpectedResultCount": 0,
				"TotalResultCount":      1,
			}),
			insert.Verdict(realm, tID2, vh, "build-2", common.VerdictStatus_VERDICT_FLAKY, oneAndHalfHAgo, map[string]interface{}{
				"IngestionTime":         halfHAgo,
				"UnexpectedResultCount": 1,
				"TotalResultCount":      2,
			}),
			insert.Verdict(realm, tID5, vh, "build-1", common.VerdictStatus_EXPECTED, twoAndHalfHAgo, map[string]interface{}{
				"IngestionTime":         now.Add(-45 * time.Minute),
				"UnexpectedResultCount": 0,
				"TotalResultCount":      1,
			}),
			insert.Verdict(realm, tID5, vh, "build-2", common.VerdictStatus_VERDICT_FLAKY, oneAndHalfHAgo, map[string]interface{}{
				"IngestionTime":         halfHAgo,
				"UnexpectedResultCount": 1,
				"TotalResultCount":      2,
			}),
