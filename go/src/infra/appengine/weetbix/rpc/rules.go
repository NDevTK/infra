...
func (*Rules) Get(ctx context.Context, req *pb.GetRuleRequest) (*pb.Rule, error) {
	...
	return createRule(r, cfg.Config), nil
}
...
func (*Rules) List(ctx context.Context, req *pb.ListRulesRequest) (*pb.ListRulesResponse, error) {
	...
	for _, r := range rs {
		rpbs = append(rpbs, createRule(r, cfg.Config))
	}
...
func (*Rules) Update(ctx context.Context, req *pb.UpdateRuleRequest) (*pb.Rule, error) {
	...
	return createRule(updatedRule, cfg.Config), nil
}
...
func createRule(r *rules.FailureAssociationRule, cfg *configpb.ProjectConfig) *pb.Rule {
	return &pb.Rule{
		Name:           createRuleName(r.Project, r.RuleID),
		Project:        r.Project,
		RuleId:         r.RuleID,
		RuleDefinition: r.RuleDefinition,
		Bug:            createAssociatedBug(r.BugID, cfg),
		IsActive:       r.IsActive,
...
func createAssociatedBug(b bugs.BugID, cfg *configpb.ProjectConfig) *pb.AssociatedBug {
