...
export const HelpPage = () => {
    return <>
        ...
        <article>
            ...
            <p>
                Sheriff-o-Matic supports a variety of different actions for alerts.
                These alert actions are shown on the left side of each alert's body.
                You can also perform actions on multiple alerts at a time by checking the
            ...
            <ul>
                ...
                <li><strong>Group</strong> related alerts together to simplify your view.
                    <ul>
                        ...
                        <li>Note that groups of alerts have their own sets of actions. At the moment,
                            actions previously applied to the alerts in a group are not added to the group.
                        </li>
                        <li>
