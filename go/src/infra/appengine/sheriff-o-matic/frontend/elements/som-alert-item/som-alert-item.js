...
Polymer({
  ...
  properties: {
    ...
    _duration: {type: String, computed: '_calculateDuration(treeName, alert)'},
    ...
    _startTime: {type: String, computed: '_formatTimestamp(alert.start_time)'},
    _groupNameInput: {
      type: Object,
      value: function() {
  ...
  _expandAlertCollapse: function() {
    this.$.alertCollapse.updateSize(String(this.$.alertCollapse.scrollHeight) +
                                    'px');
  },
