...
Polymer({
  ...
  _expects: function(item, val) {
    ...
    let ret = item.Expectations.some((v) => {
      return v == val;
    });
    return ret;
  },
  ...
  _toggleExpectation: function(evt) {
    ...
    this._editValue.Expectations =
        this._editValue.Expectations.filter((v, i) => {
          return pos != i;
        });
  },
  ...
  _toggleModifier: function(evt) {
    ...
    this._editValue.Modifiers = this._editValue.Modifiers.filter((v, i) => {
      return pos != i;
    });
  },
