...
func shouldUseCache(tree string) bool {
	trees := []string{"android", "chromium", "chromium.gpu", "ios", "chromium.perf", "chrome_browser_release", "chromium.clang", "chromium.fuzz", "lacros_skylab"}
	return sliceContains(trees, tree)
}

func getFilterFuncForTree(tree string) (func(failureRow) bool, error) {
	switch tree {
	case "android", "chrome_browser_release", "chromium", "chromium.clang", "chromium.gpu", "chromium.perf", "chromium.fuzz", "ios", "lacros_skylab":
