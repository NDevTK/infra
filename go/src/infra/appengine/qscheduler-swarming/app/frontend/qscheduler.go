...
func toTaskInstantState(s swarming.TaskState) (reconciler.TaskInstant_State, bool) {
	...
	// These category cases occurr in the same order as they are defined in
	...
	case swarming.TaskStateCategory_CATEGORY_TRANSIENT_DONE:
		fallthrough
	case swarming.TaskStateCategory_CATEGORY_EXECUTION_DONE:
		fallthrough
	case swarming.TaskStateCategory_CATEGORY_NEVER_RAN_DONE:
