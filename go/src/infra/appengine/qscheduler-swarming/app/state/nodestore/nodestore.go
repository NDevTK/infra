...
type Operator interface {
	// Modify is called to modify a quotascheduler state; this should not cause
	// any side effects, because it may be called more than once.
...
// stateNode is the datastore entity used to represent the parent of a
// collection of children; the children in turn store shards of the state.
//
// stateNode entities are append-only, and never modified.
//
