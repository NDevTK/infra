...
type batchable interface {
	// Close causes this batchable to emit any stored errors and close.
	Close()
	// SetError sets current error for this batchable.
	SetError(error)
...
func (b *batchedRequest) SetError(err error) {
	b.err = err
}
