...
type (
	...
	aclHandle struct{ stiface.ACLHandle }
)
...
func (b bucketHandle) Object(name string) stiface.ObjectHandle {
	return objectHandle{}
}

func (o objectHandle) ReadCompressed(compressed bool) stiface.ObjectHandle {
	return objectHandle{}
}

func (o objectHandle) NewReader(ctx context.Context) (stiface.Reader, error) {
	var r reader
...
func TestGetFile(t *testing.T) {
	...
	adaptCreateClient = func(c *storage.Client) stiface.Client {
		return client{}
	}
	testName := "test"
	testID := "abc1234"
