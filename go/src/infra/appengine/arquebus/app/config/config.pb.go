...
type Trooper_Position int32

const (
	Trooper_UNSET     Trooper_Position = 0
	Trooper_PRIMARY   Trooper_Position = 1
	Trooper_SECONDARY Trooper_Position = 2
)

// Enum value maps for Trooper_Position.
var (
	Trooper_Position_name = map[int32]string{
		0: "UNSET",
		1: "PRIMARY",
		2: "SECONDARY",
	}
	Trooper_Position_value = map[string]int32{
		"UNSET":     0,
		"PRIMARY":   1,
		"SECONDARY": 2,
	}
...
func (x Trooper_Position) Enum() *Trooper_Position {
	p := new(Trooper_Position)
	*p = x
	return p
}

func (x Trooper_Position) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Trooper_Position) Descriptor() protoreflect.EnumDescriptor {
	return file_infra_appengine_arquebus_app_config_config_proto_enumTypes[1].Descriptor()
}

func (Trooper_Position) Type() protoreflect.EnumType {
	return &file_infra_appengine_arquebus_app_config_config_proto_enumTypes[1]
}

func (x Trooper_Position) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Trooper_Position.Descriptor instead.
func (Trooper_Position) EnumDescriptor() ([]byte, []int) {
	return file_infra_appengine_arquebus_app_config_config_proto_rawDescGZIP(), []int{3, 0}
}
...
// Deprecated: Use Trooper instead.
type Oncall struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
type Trooper struct {
	...
	// The name of the rotation to look for the current trooper from.
	//
	// This is the name of a rotation proxied in RotationProxy.
	Rotation string `protobuf:"bytes,1,opt,name=rotation,proto3" json:"rotation,omitempty"`
	// The position of the trooper referred.
	//
	// The value must be either PRIMARY or SECONDARY. UNSET or omitting the value
	// of this field will cause the config failed in validation.
	Position Trooper_Position `protobuf:"varint,2,opt,name=position,proto3,enum=arquebus.config.Trooper_Position" json:"position,omitempty"`
}

func (x *Trooper) Reset() {
	*x = Trooper{}
	if protoimpl.UnsafeEnabled {
...
func (x *Trooper) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Trooper) ProtoMessage() {}

func (x *Trooper) ProtoReflect() protoreflect.Message {
	mi := &file_infra_appengine_arquebus_app_config_config_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Trooper.ProtoReflect.Descriptor instead.
func (*Trooper) Descriptor() ([]byte, []int) {
	return file_infra_appengine_arquebus_app_config_config_proto_rawDescGZIP(), []int{3}
}

func (x *Trooper) GetRotation() string {
	if x != nil {
		return x.Rotation
	}
	return ""
...
func (x *Trooper) GetPosition() Trooper_Position {
	if x != nil {
		return x.Position
	}
	return Trooper_UNSET
}
...
func (x *UserSource) GetTrooper() *Trooper {
	if x, ok := x.GetFrom().(*UserSource_Trooper); ok {
		return x.Trooper
	}
	return nil
}
...
type UserSource_Oncall struct {
	// Deprecated: Use UserSource.Trooper instead.
	//
	// Deprecated: Do not use.
...
type UserSource_Trooper struct {
	// A trooper of the current shift in a given rotation.
	Trooper *Trooper `protobuf:"bytes,4,opt,name=trooper,proto3,oneof"`
}
...
func (*UserSource_Trooper) isUserSource_From() {}
...
func (x *Assigner) Reset() {
	*x = Assigner{}
	if protoimpl.UnsafeEnabled {
		mi := &file_infra_appengine_arquebus_app_config_config_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Assigner) Descriptor() ([]byte, []int) {
	return file_infra_appengine_arquebus_app_config_config_proto_rawDescGZIP(), []int{5}
}
...
var file_infra_appengine_arquebus_app_config_config_proto_rawDesc = []byte{
	...
	0x02, 0x22, 0x97, 0x01, 0x0a, 0x07, 0x54, 0x72, 0x6f, 0x6f, 0x70, 0x65, 0x72, 0x12, 0x1a, 0x0a,
	0x08, 0x72, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x08, 0x72, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3d, 0x0a, 0x08, 0x70, 0x6f, 0x73,
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x61, 0x72,
	0x71, 0x75, 0x65, 0x62, 0x75, 0x73, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x54, 0x72,
	0x6f, 0x6f, 0x70, 0x65, 0x72, 0x2e, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x08,
	0x70, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x31, 0x0a, 0x08, 0x50, 0x6f, 0x73, 0x69,
	...
	,
...
var file_infra_appengine_arquebus_app_config_config_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_infra_appengine_arquebus_app_config_config_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_infra_appengine_arquebus_app_config_config_proto_goTypes = []interface{}{
	...
	(Trooper_Position)(0),     // 1: arquebus.config.Trooper.Position
	(*Config)(nil),            // 2: arquebus.config.Config
	(*IssueQuery)(nil),        // 3: arquebus.config.IssueQuery
	(*Oncall)(nil),            // 4: arquebus.config.Oncall
	(*Trooper)(nil),           // 5: arquebus.config.Trooper
	(*UserSource)(nil),        // 6: arquebus.config.UserSource
	(*Assigner)(nil),          // 7: arquebus.config.Assigner
	(*duration.Duration)(nil), // 8: google.protobuf.Duration
}
var file_infra_appengine_arquebus_app_config_config_proto_depIdxs = []int32{
	7,  // 0: arquebus.config.Config.assigners:type_name -> arquebus.config.Assigner
	0,  // 1: arquebus.config.Oncall.position:type_name -> arquebus.config.Oncall.Position
	1,  // 2: arquebus.config.Trooper.position:type_name -> arquebus.config.Trooper.Position
	4,  // 3: arquebus.config.UserSource.oncall:type_name -> arquebus.config.Oncall
	4,  // 4: arquebus.config.UserSource.rotation:type_name -> arquebus.config.Oncall
	5,  // 5: arquebus.config.UserSource.trooper:type_name -> arquebus.config.Trooper
	8,  // 6: arquebus.config.Assigner.interval:type_name -> google.protobuf.Duration
	3,  // 7: arquebus.config.Assigner.issue_query:type_name -> arquebus.config.IssueQuery
	6,  // 8: arquebus.config.Assigner.assignees:type_name -> arquebus.config.UserSource
	6,  // 9: arquebus.config.Assigner.ccs:type_name -> arquebus.config.UserSource
...
func file_infra_appengine_arquebus_app_config_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_infra_appengine_arquebus_app_config_config_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_infra_appengine_arquebus_app_config_config_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*UserSource_Oncall)(nil),
		(*UserSource_Email)(nil),
		(*UserSource_Rotation)(nil),
		(*UserSource_Trooper)(nil),
	}
	type x struct{}
