...
type DutObject struct {
	...
	// hive information of the DUT to match a drone.
	// Satlab duts hive is "satlab-<ID>"
	// gTransit duts hive is "gtransit"
	// main lab duts hive is empty
...
type DeclareDutsRequest struct {
	...
	Duts []string `protobuf:"bytes,1,rep,name=duts,proto3" json:"duts,omitempty"` // Deprecated field. Will be removed in next CL.
