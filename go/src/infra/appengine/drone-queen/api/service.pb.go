...
func (x *AvailableDuts) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AvailableDuts) ProtoMessage() {}

func (x *AvailableDuts) ProtoReflect() protoreflect.Message {
	mi := &file_infra_appengine_drone_queen_api_service_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AvailableDuts.ProtoReflect.Descriptor instead.
func (*AvailableDuts) Descriptor() ([]byte, []int) {
	return file_infra_appengine_drone_queen_api_service_proto_rawDescGZIP(), []int{4}
}

func (x *AvailableDuts) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AvailableDuts) GetHive() string {
	if x != nil {
		return x.Hive
	}
	return ""
...
type DeclareDutsRequest struct {
	...
	// drained and deleted.
	AvailableDuts []*AvailableDuts `protobuf:"bytes,2,rep,name=available_duts,json=availableDuts,proto3" json:"available_duts,omitempty"`
}
...
func (x *DeclareDutsRequest) GetAvailableDuts() []*AvailableDuts {
	if x != nil {
...
var file_infra_appengine_drone_queen_api_service_proto_rawDesc = []byte{
	...
	,
...
var file_infra_appengine_drone_queen_api_service_proto_goTypes = []interface{}{
	...
	(*AvailableDuts)(nil),                     // 5: drone_queen.AvailableDuts
...
var file_infra_appengine_drone_queen_api_service_proto_depIdxs = []int32{
	...
	5,  // 3: drone_queen.DeclareDutsRequest.available_duts:type_name -> drone_queen.AvailableDuts
