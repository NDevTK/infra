...
// PushLabstationsForRepair implements the fleet.Tracker.pushLabstationsForRepair() method.
func (tsi *TrackerServerImpl) PushLabstationsForRepair(ctx context.Context, req *fleet.PushLabstationsForRepairRequest) (res *fleet.PushLabstationsForRepairResponse, err error) {
	defer func() {
		err = grpcutil.GRPCifyAndLogErr(ctx, err)
	}()
	...
	return &fleet.PushLabstationsForRepairResponse{}, nil
}
