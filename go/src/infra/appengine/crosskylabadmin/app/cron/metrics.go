...
var (
	...
	pushLabstationsForRepairCronHandlerTick = metric.NewCounter(
		"chromeos/crosskylabadmin/cron/push_labstations_for_repair",
		"PushLabstationsForRepair cron attempt",
		nil,
		field.Bool("success"),
	)
