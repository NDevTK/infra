...
func foundPropertyWithNoOwnershipSpecifier(path string, startLine int, endLine int, functionEndChar int) *tricium.Data_Comment {
	return &tricium.Data_Comment{
		Category:  fmt.Sprintf("ObjectiveCStyle/ExplicitOwnership"),
