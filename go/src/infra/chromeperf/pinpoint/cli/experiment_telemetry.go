...
var (
	botCfgs = map[string]string{
		...
		"android-pixel6-perf":              "performance_test_suite_android_clank_trichrome_bundle",
		"android-pixel6-perf-pgo":          "performance_test_suite_android_clank_trichrome_bundle",
		"android-pixel6-pro-perf":          "performance_test_suite_android_clank_trichrome_bundle",
		"android-pixel6-pro-perf-pgo":      "performance_test_suite_android_clank_trichrome_bundle",
