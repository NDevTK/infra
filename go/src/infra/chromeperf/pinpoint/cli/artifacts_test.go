...
func TestCasHandling(t *testing.T) {
	Convey("Parse components from CAS URL", t, func() {
		instance, hash, bytes := extractCasParamsFromURL("https://cas-viewer.appspot.com/projects/chrome-swarming/instances/default_instance/blobs/327d759be13ebe68392ab8deec4fba29243b96eea2cdc10a2a3b7eac44088123/176/tree")
