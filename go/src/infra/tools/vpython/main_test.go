...
func (tc *testCase) runCommon(t *testing.T, c context.Context, td string, exitCode int) {
...
func (tc *testCase) runTestSignals(t *testing.T, c context.Context, td string) {
