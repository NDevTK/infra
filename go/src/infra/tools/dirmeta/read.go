...
// ReadMapping reads metadata from the directory tree at root.
...
// All returned metadata includes inherited metadata from root.
// The returned mapping does not include entries for directories not among
// targets.
//
