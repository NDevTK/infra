...
func (s *Server) CreateFakeOmaha(ctx context.Context, req *tls.CreateFakeOmahaRequest) (fo *tls.FakeOmaha, err error) {
	fo = req.GetFakeOmaha()
	...
	// TODO(guocb): defer a function to close the tunnel.
