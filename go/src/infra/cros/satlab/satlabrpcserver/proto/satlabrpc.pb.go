...
var file_satlabrpc_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x4c, 0x69, 0x6e, 0x6b, 0x32, 0xcc, 0x17, 0x0a, 0x10, 0x53, 0x61, 0x74, 0x6c, 0x61,
	...
	0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x88, 0x01, 0x0a, 0x0b, 0x53,
	0x74, 0x61, 0x72, 0x74, 0x53, 0x65, 0x72, 0x76, 0x6f, 0x64, 0x12, 0x27, 0x2e, 0x63, 0x68, 0x72,
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x2d, 0xd2, 0x41, 0x2a, 0x0a, 0x13, 0x53, 0x74, 0x61,
	0x72, 0x74, 0x53, 0x65, 0x72, 0x76, 0x6f, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x13, 0x53, 0x74, 0x61, 0x72, 0x74, 0x53, 0x65, 0x72, 0x76, 0x6f, 0x64, 0x4d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0x23, 0x5a, 0x21, 0x69, 0x6e, 0x66, 0x72, 0x61, 0x2f, 0x63,
...
var file_satlabrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 71)
var file_satlabrpc_proto_goTypes = []interface{}{
	...
	(*UpdatePoolRequest_Item)(nil),            // 68: satlabrpcserver.UpdatePoolRequest.Item
	(*AddDutsRequest_Param)(nil),              // 69: satlabrpcserver.AddDutsRequest.Param
	(*AddDutsResponse_PassedData)(nil),        // 70: satlabrpcserver.AddDutsResponse.PassedData
	(*AddDutsResponse_FailedData)(nil),        // 71: satlabrpcserver.AddDutsResponse.FailedData
	(*timestamppb.Timestamp)(nil),             // 72: google.protobuf.Timestamp
	(*test_platform.Request_TestPlan)(nil),    // 73: test_platform.Request.TestPlan
	(*api.StartServodRequest)(nil),            // 74: chromiumos.test.api.StartServodRequest
	(*longrunning.Operation)(nil),             // 75: chromiumos.longrunning.Operation
}
var file_satlabrpc_proto_depIdxs = []int32{
	...
	72, // 5: satlabrpcserver.GetSystemInfoResponse.start_time:type_name -> google.protobuf.Timestamp
	...
	68, // 8: satlabrpcserver.UpdatePoolRequest.items:type_name -> satlabrpcserver.UpdatePoolRequest.Item
	72, // 9: satlabrpcserver.GetDutDetailResponse.first_seen_ts:type_name -> google.protobuf.Timestamp
	72, // 10: satlabrpcserver.GetDutDetailResponse.last_seen_ts:type_name -> google.protobuf.Timestamp
	33, // 11: satlabrpcserver.GetDutDetailResponse.dimensions:type_name -> satlabrpcserver.StringListPair
	72, // 12: satlabrpcserver.Task.start_at:type_name -> google.protobuf.Timestamp
	36, // 13: satlabrpcserver.ListDutTasksResponse.tasks:type_name -> satlabrpcserver.Task
	72, // 14: satlabrpcserver.BotEvent.created_at:type_name -> google.protobuf.Timestamp
	...
	69, // 19: satlabrpcserver.AddDutsRequest.duts:type_name -> satlabrpcserver.AddDutsRequest.Param
	70, // 20: satlabrpcserver.AddDutsResponse.pass:type_name -> satlabrpcserver.AddDutsResponse.PassedData
	71, // 21: satlabrpcserver.AddDutsResponse.fail:type_name -> satlabrpcserver.AddDutsResponse.FailedData
	23, // 22: satlabrpcserver.RunTestPlanRequest.dims:type_name -> satlabrpcserver.Dim
	73, // 23: satlabrpcserver.GetTestPlanResponse.plan:type_name -> test_platform.Request.TestPlan
	...
	74, // 53: satlabrpcserver.SatlabRpcService.StartServod:input_type -> chromiumos.test.api.StartServodRequest
	8,  // 54: satlabrpcserver.SatlabRpcService.list_accessible_models:output_type -> satlabrpcserver.ListAccessibleModelsResponse
	10, // 55: satlabrpcserver.SatlabRpcService.list_build_versions:output_type -> satlabrpcserver.ListBuildVersionsResponse
	12, // 56: satlabrpcserver.SatlabRpcService.stage_build:output_type -> satlabrpcserver.StageBuildResponse
	15, // 57: satlabrpcserver.SatlabRpcService.list_connected_duts_firmware:output_type -> satlabrpcserver.ListConnectedDutsFirmwareResponse
	17, // 58: satlabrpcserver.SatlabRpcService.get_system_info:output_type -> satlabrpcserver.GetSystemInfoResponse
	27, // 59: satlabrpcserver.SatlabRpcService.get_version_info:output_type -> satlabrpcserver.GetVersionInfoResponse
	51, // 60: satlabrpcserver.SatlabRpcService.get_network_info:output_type -> satlabrpcserver.GetNetworkInfoResponse
	19, // 61: satlabrpcserver.SatlabRpcService.get_peripheral_information:output_type -> satlabrpcserver.GetPeripheralInformationResponse
	22, // 62: satlabrpcserver.SatlabRpcService.update_duts_firmware:output_type -> satlabrpcserver.UpdateDutsFirmwareResponse
	2,  // 63: satlabrpcserver.SatlabRpcService.list_build_targets:output_type -> satlabrpcserver.ListBuildTargetsResponse
	5,  // 64: satlabrpcserver.SatlabRpcService.list_milestones:output_type -> satlabrpcserver.ListMilestonesResponse
	55, // 65: satlabrpcserver.SatlabRpcService.list_test_plans:output_type -> satlabrpcserver.ListTestPlansResponse
	59, // 66: satlabrpcserver.SatlabRpcService.get_test_plan:output_type -> satlabrpcserver.GetTestPlanResponse
	25, // 67: satlabrpcserver.SatlabRpcService.run_suite:output_type -> satlabrpcserver.RunSuiteResponse
	42, // 68: satlabrpcserver.SatlabRpcService.run_test:output_type -> satlabrpcserver.RunTestResponse
	57, // 69: satlabrpcserver.SatlabRpcService.run_test_plan:output_type -> satlabrpcserver.RunTestPlanResponse
	29, // 70: satlabrpcserver.SatlabRpcService.add_pool:output_type -> satlabrpcserver.AddPoolResponse
	31, // 71: satlabrpcserver.SatlabRpcService.update_pool:output_type -> satlabrpcserver.UpdatePoolResponse
	49, // 72: satlabrpcserver.SatlabRpcService.delete_duts:output_type -> satlabrpcserver.DeleteDutsResponse
	53, // 73: satlabrpcserver.SatlabRpcService.add_duts:output_type -> satlabrpcserver.AddDutsResponse
	34, // 74: satlabrpcserver.SatlabRpcService.get_dut_detail:output_type -> satlabrpcserver.GetDutDetailResponse
	37, // 75: satlabrpcserver.SatlabRpcService.list_dut_tasks:output_type -> satlabrpcserver.ListDutTasksResponse
	40, // 76: satlabrpcserver.SatlabRpcService.list_dut_events:output_type -> satlabrpcserver.ListDutEventsResponse
	45, // 77: satlabrpcserver.SatlabRpcService.list_enrolled_duts:output_type -> satlabrpcserver.ListEnrolledDutsResponse
	47, // 78: satlabrpcserver.SatlabRpcService.list_duts:output_type -> satlabrpcserver.ListDutsResponse
	61, // 79: satlabrpcserver.SatlabRpcService.set_cloud_configuration:output_type -> satlabrpcserver.SetCloudConfigurationResponse
	63, // 80: satlabrpcserver.SatlabRpcService.get_cloud_configuration:output_type -> satlabrpcserver.GetCloudConfigurationResponse
	65, // 81: satlabrpcserver.SatlabRpcService.reboot:output_type -> satlabrpcserver.RebootResponse
	67, // 82: satlabrpcserver.SatlabRpcService.upload_log:output_type -> satlabrpcserver.UploadLogResponse
	75, // 83: satlabrpcserver.SatlabRpcService.StartServod:output_type -> chromiumos.longrunning.Operation
