...
var file_satlabrpc_proto_rawDesc = []byte{
	...
	0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x32, 0x95, 0x11, 0x0a, 0x10, 0x53, 0x61, 0x74, 0x6c,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4d, 0x0a, 0x08, 0x72, 0x75, 0x6e, 0x5f, 0x74, 0x65, 0x73,
...
var file_satlabrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_satlabrpc_proto_goTypes = []interface{}{
	...
	(*UpdatePoolRequest_Item)(nil),            // 53: satlabrpcserver.UpdatePoolRequest.Item
	(*AddDutsRequest_Param)(nil),              // 54: satlabrpcserver.AddDutsRequest.Param
	(*AddDutsResponse_PassedData)(nil),        // 55: satlabrpcserver.AddDutsResponse.PassedData
	(*AddDutsResponse_FailedData)(nil),        // 56: satlabrpcserver.AddDutsResponse.FailedData
...
var file_satlabrpc_proto_depIdxs = []int32{
	...
	57, // 5: satlabrpcserver.GetSystemInfoResponse.start_time:type_name -> google.protobuf.Timestamp
	21, // 6: satlabrpcserver.UpdateDutsFirmwareResponse.outputs:type_name -> satlabrpcserver.FirmwareUpdateCommandOutput
	53, // 7: satlabrpcserver.UpdatePoolRequest.items:type_name -> satlabrpcserver.UpdatePoolRequest.Item
	57, // 8: satlabrpcserver.GetDutDetailResponse.first_seen_ts:type_name -> google.protobuf.Timestamp
	57, // 9: satlabrpcserver.GetDutDetailResponse.last_seen_ts:type_name -> google.protobuf.Timestamp
	32, // 10: satlabrpcserver.GetDutDetailResponse.dimensions:type_name -> satlabrpcserver.StringListPair
	57, // 11: satlabrpcserver.Task.start_at:type_name -> google.protobuf.Timestamp
	35, // 12: satlabrpcserver.ListDutTasksResponse.tasks:type_name -> satlabrpcserver.Task
	57, // 13: satlabrpcserver.BotEvent.created_at:type_name -> google.protobuf.Timestamp
	...
	54, // 17: satlabrpcserver.AddDutsRequest.duts:type_name -> satlabrpcserver.AddDutsRequest.Param
	55, // 18: satlabrpcserver.AddDutsResponse.pass:type_name -> satlabrpcserver.AddDutsResponse.PassedData
	56, // 19: satlabrpcserver.AddDutsResponse.fail:type_name -> satlabrpcserver.AddDutsResponse.FailedData
	1,  // 20: satlabrpcserver.SatlabRpcService.list_build_targets:input_type -> satlabrpcserver.ListBuildTargetsRequest
	4,  // 21: satlabrpcserver.SatlabRpcService.list_milestones:input_type -> satlabrpcserver.ListMilestonesRequest
	6,  // 22: satlabrpcserver.SatlabRpcService.list_accessible_models:input_type -> satlabrpcserver.ListAccessibleModelsRequest
	9,  // 23: satlabrpcserver.SatlabRpcService.list_build_versions:input_type -> satlabrpcserver.ListBuildVersionsRequest
	11, // 24: satlabrpcserver.SatlabRpcService.stage_build:input_type -> satlabrpcserver.StageBuildRequest
	13, // 25: satlabrpcserver.SatlabRpcService.list_connected_duts_firmware:input_type -> satlabrpcserver.ListConnectedDutsFirmwareRequest
	16, // 26: satlabrpcserver.SatlabRpcService.get_system_info:input_type -> satlabrpcserver.GetSystemInfoRequest
	25, // 27: satlabrpcserver.SatlabRpcService.get_version_info:input_type -> satlabrpcserver.GetVersionInfoRequest
	49, // 28: satlabrpcserver.SatlabRpcService.get_network_info:input_type -> satlabrpcserver.GetNetworkInfoRequest
	18, // 29: satlabrpcserver.SatlabRpcService.get_peripheral_information:input_type -> satlabrpcserver.GetPeripheralInformationRequest
	20, // 30: satlabrpcserver.SatlabRpcService.update_duts_firmware:input_type -> satlabrpcserver.UpdateDutsFirmwareRequest
	23, // 31: satlabrpcserver.SatlabRpcService.run_suite:input_type -> satlabrpcserver.RunSuiteRequest
	40, // 32: satlabrpcserver.SatlabRpcService.run_test:input_type -> satlabrpcserver.RunTestRequest
	27, // 33: satlabrpcserver.SatlabRpcService.add_pool:input_type -> satlabrpcserver.AddPoolRequest
	29, // 34: satlabrpcserver.SatlabRpcService.update_pool:input_type -> satlabrpcserver.UpdatePoolRequest
	47, // 35: satlabrpcserver.SatlabRpcService.delete_duts:input_type -> satlabrpcserver.DeleteDutsRequest
	51, // 36: satlabrpcserver.SatlabRpcService.add_duts:input_type -> satlabrpcserver.AddDutsRequest
	31, // 37: satlabrpcserver.SatlabRpcService.get_dut_detail:input_type -> satlabrpcserver.GetDutDetailRequest
	34, // 38: satlabrpcserver.SatlabRpcService.list_dut_tasks:input_type -> satlabrpcserver.ListDutTasksRequest
	37, // 39: satlabrpcserver.SatlabRpcService.list_dut_events:input_type -> satlabrpcserver.ListDutEventsRequest
	42, // 40: satlabrpcserver.SatlabRpcService.list_enrolled_duts:input_type -> satlabrpcserver.ListEnrolledDutsRequest
	45, // 41: satlabrpcserver.SatlabRpcService.list_duts:input_type -> satlabrpcserver.ListDutsRequest
	2,  // 42: satlabrpcserver.SatlabRpcService.list_build_targets:output_type -> satlabrpcserver.ListBuildTargetsResponse
	5,  // 43: satlabrpcserver.SatlabRpcService.list_milestones:output_type -> satlabrpcserver.ListMilestonesResponse
	...
	24, // 53: satlabrpcserver.SatlabRpcService.run_suite:output_type -> satlabrpcserver.RunSuiteResponse
	41, // 54: satlabrpcserver.SatlabRpcService.run_test:output_type -> satlabrpcserver.RunTestResponse
	28, // 55: satlabrpcserver.SatlabRpcService.add_pool:output_type -> satlabrpcserver.AddPoolResponse
	30, // 56: satlabrpcserver.SatlabRpcService.update_pool:output_type -> satlabrpcserver.UpdatePoolResponse
	48, // 57: satlabrpcserver.SatlabRpcService.delete_duts:output_type -> satlabrpcserver.DeleteDutsResponse
	52, // 58: satlabrpcserver.SatlabRpcService.add_duts:output_type -> satlabrpcserver.AddDutsResponse
	33, // 59: satlabrpcserver.SatlabRpcService.get_dut_detail:output_type -> satlabrpcserver.GetDutDetailResponse
	36, // 60: satlabrpcserver.SatlabRpcService.list_dut_tasks:output_type -> satlabrpcserver.ListDutTasksResponse
	39, // 61: satlabrpcserver.SatlabRpcService.list_dut_events:output_type -> satlabrpcserver.ListDutEventsResponse
	44, // 62: satlabrpcserver.SatlabRpcService.list_enrolled_duts:output_type -> satlabrpcserver.ListEnrolledDutsResponse
	46, // 63: satlabrpcserver.SatlabRpcService.list_duts:output_type -> satlabrpcserver.ListDutsResponse
