	...
	tests := []*test{
		{
			...
			&builder.CTPBuilder{
				...
				TimeoutMins:         360,
				CTPBuildTags:        map[string]string{"label-suite": "rlz", "satlab-id": "", "test-type": "suite"},
				TestRunnerBuildTags: map[string]string{"label-suite": "rlz", "satlab-id": "", "test-type": "suite"},
			},
		},
		{
			...
			&builder.CTPBuilder{
				...
				TestRunnerBuildTags: map[string]string{"satlab-id": "", "test-type": "test"},
				CTPBuildTags:        map[string]string{"satlab-id": "", "test-type": "test"},
		...
		},
		{
			...
			&builder.CTPBuilder{
				...
				CTPBuildTags:        map[string]string{"satlab-id": "", "test-plan-id": "testplan", "test-type": "testplan"},
				TestRunnerBuildTags: map[string]string{"satlab-id": "", "test-plan-id": "testplan", "test-type": "testplan"},
				TimeoutMins:         360,
			},
		},
	}
