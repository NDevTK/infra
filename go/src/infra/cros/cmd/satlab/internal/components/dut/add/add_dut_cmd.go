...
func (c *addDUT) innerRun(a subcommands.Application, args []string, env subcommands.Env) error {
	...
	c.qualifiedHostname = common.MaybePrepend("satlab", dockerHostBoxIdentifier, c.hostname)
	c.qualifiedRack = common.MaybePrepend("satlab", dockerHostBoxIdentifier, c.rack)
	c.qualifiedServo = common.MaybePrepend("satlab", dockerHostBoxIdentifier, c.servo)
