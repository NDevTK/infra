...
func NewNonTemplatedContainer(
	...
	ctr managers.ContainerManager) *NonTemplatedContainer {

	cont := &NonTemplatedContainer{AbstractContainer: NewAbstractContainer(namePrefix, containerImage, ctr)}
...
// StartContainer starts the container. (This is called by the abstract_container process flow.)
