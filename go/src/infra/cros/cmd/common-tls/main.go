...
var (
	...
	dutSSHKey = flag.String("dut-ssh-key", "", "Path to alternate SSH key to use to access DUTs. The default key in wellknown_ssh_key.go in tlslib will be tried first. This key will be tried as a fallback if the wellknown_ssh_key fails.")
)
