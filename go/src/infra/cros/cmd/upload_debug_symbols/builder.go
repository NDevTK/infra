...
// file.
func crashRetrieveUploadInformation(uploadInfo *crashUploadInformation, crash crashConnectionInfo) (int, error) {
...
func upload(task *taskConfig, crash crashConnectionInfo) bool {
	...
	statusCode, err := crashRetrieveUploadInformation(&uploadInfo, crash)
