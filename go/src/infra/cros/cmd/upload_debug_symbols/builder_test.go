...
// TestUploadWorker will test that netarWriterork uploads are going to the correct place
...
func TestUnpackTarball(t *testing.T) {
	...
	// Verify that we recieved a list pointing to all the expected files and no others.
