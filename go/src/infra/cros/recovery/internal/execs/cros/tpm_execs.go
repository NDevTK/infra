...
const (
	// Expected value of tpm dev-signed firmware and kernal version.
...
// isOnDevTPMKernelVersionExec confirms dut is operating dev's tpm kernal version.
//
...
func init() {
	execs.Register("cros_is_tpm_firmware_version_correct", isOnDevTPMFirmwareVersionExec)
	execs.Register("cros_is_tpm_kernel_version_correct", isOnDevTPMKernelVersionExec)
}
