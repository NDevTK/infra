...
func Run(ctx context.Context, args *RunArgs) error {
	...
	for ir, resource := range resources {
		...
		printDUTInfo(ctx, resource, dut, "received DUT")
		...
		printDUTInfo(ctx, resource, dut, "updated DUT")
...
func printDUTInfo(ctx context.Context, resource string, dut *tlw.Dut, msg string) {
