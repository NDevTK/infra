...
// Servo Topology describes servo devices used to provide Servo functionality.
type ServoTopology struct {
	Main     *ServoTopologyItem
	Children []*ServoTopologyItem
}

// Servo Topology Item describes details of one servo device.
