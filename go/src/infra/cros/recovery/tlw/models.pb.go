...
var file_infra_cros_recovery_tlw_models_proto_rawDesc = []byte{
	...
	0x06, 0x42, 0x52, 0x4f, 0x4b, 0x45, 0x4e, 0x10, 0x02, 0x22, 0xaa, 0x01, 0x0a, 0x0e, 0x56, 0x65,
...
var file_infra_cros_recovery_tlw_models_proto_goTypes = []interface{}{
	...
	(api.WifiRouterFeature)(0),              // 52: chromiumos.test.lab.api.WifiRouterFeature
	(api.WifiRouterDeviceType)(0),           // 53: chromiumos.test.lab.api.WifiRouterDeviceType
	(*api.UsbDrive)(nil),                    // 54: chromiumos.test.lab.api.UsbDrive
	(*api.Cbi)(nil),                         // 55: chromiumos.test.lab.api.Cbi
}
var file_infra_cros_recovery_tlw_models_proto_depIdxs = []int32{
	...
	52, // 7: chromeos.recovery.WifiRouterHost.features:type_name -> chromiumos.test.lab.api.WifiRouterFeature
	53, // 8: chromeos.recovery.WifiRouterHost.device_type:type_name -> chromiumos.test.lab.api.WifiRouterDeviceType
	5,  // 9: chromeos.recovery.VersionRequest.type:type_name -> chromeos.recovery.VersionRequest.VersionType
	48, // 10: chromeos.recovery.VersionResponse.value:type_name -> chromeos.recovery.VersionResponse.ValueEntry
	6,  // 11: chromeos.recovery.DUTAudio.loopback_state:type_name -> chromeos.recovery.DUTAudio.LoopbackState
	29, // 12: chromeos.recovery.InitServodRequest.options:type_name -> chromeos.recovery.ServodOptions
	31, // 13: chromeos.recovery.ServoTopology.root:type_name -> chromeos.recovery.ServoTopologyItem
	31, // 14: chromeos.recovery.ServoTopology.children:type_name -> chromeos.recovery.ServoTopologyItem
	...
	30, // 18: chromeos.recovery.ServoHost.servo_topology:type_name -> chromeos.recovery.ServoTopology
	54, // 19: chromeos.recovery.ServoHost.usb_drive:type_name -> chromiumos.test.lab.api.UsbDrive
	...
	27, // 34: chromeos.recovery.ChromeOS.audio:type_name -> chromeos.recovery.DUTAudio
	34, // 35: chromeos.recovery.ChromeOS.storage:type_name -> chromeos.recovery.Storage
	40, // 36: chromeos.recovery.ChromeOS.battery:type_name -> chromeos.recovery.Battery
	37, // 37: chromeos.recovery.ChromeOS.wifi:type_name -> chromeos.recovery.Wifi
	38, // 38: chromeos.recovery.ChromeOS.bluetooth:type_name -> chromeos.recovery.Bluetooth
	32, // 39: chromeos.recovery.ChromeOS.servo:type_name -> chromeos.recovery.ServoHost
	35, // 40: chromeos.recovery.ChromeOS.chameleon:type_name -> chromeos.recovery.Chameleon
	36, // 41: chromeos.recovery.ChromeOS.bluetooth_peers:type_name -> chromeos.recovery.BluetoothPeer
	...
	52, // 44: chromeos.recovery.ChromeOS.wifi_router_features:type_name -> chromiumos.test.lab.api.WifiRouterFeature
	23, // 45: chromeos.recovery.ChromeOS.rpm_outlet:type_name -> chromeos.recovery.RPMOutlet
	49, // 46: chromeos.recovery.ChromeOS.ro_vpd_map:type_name -> chromeos.recovery.ChromeOS.RoVpdMapEntry
	55, // 47: chromeos.recovery.ChromeOS.cbi:type_name -> chromiumos.test.lab.api.Cbi
	39, // 48: chromeos.recovery.ChromeOS.cellular:type_name -> chromeos.recovery.Cellular
	41, // 49: chromeos.recovery.ChromeOS.human_motion_robot:type_name -> chromeos.recovery.HumanMotionRobot
	32, // 50: chromeos.recovery.DevBoard.servo:type_name -> chromeos.recovery.ServoHost
	51, // 51: chromeos.recovery.CallServodRequest.args:type_name -> chromiumos.config.api.test.xmlrpc.Value
	50, // 52: chromeos.recovery.CallServodRequest.timeout:type_name -> google.protobuf.Duration
	51, // 53: chromeos.recovery.CallServodResponse.value:type_name -> chromiumos.config.api.test.xmlrpc.Value
