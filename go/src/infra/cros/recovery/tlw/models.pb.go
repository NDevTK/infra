...
var file_infra_cros_recovery_tlw_models_proto_goTypes = []interface{}{
	...
	(*DevBoard)(nil),                  // 41: chromeos.recovery.DevBoard
	(*CopyRequest)(nil),               // 42: chromeos.recovery.CopyRequest
	(*CallServodRequest)(nil),         // 43: chromeos.recovery.CallServodRequest
	(*CallServodResponse)(nil),        // 44: chromeos.recovery.CallServodResponse
	nil,                               // 45: chromeos.recovery.VersionResponse.ValueEntry
	nil,                               // 46: chromeos.recovery.ChromeOS.RoVpdMapEntry
	(*durationpb.Duration)(nil),       // 47: google.protobuf.Duration
	(*xmlrpc.Value)(nil),              // 48: chromiumos.config.api.test.xmlrpc.Value
	(*api.UsbDrive)(nil),              // 49: chromiumos.test.lab.api.UsbDrive
	(*api.Cbi)(nil),                   // 50: chromiumos.test.lab.api.Cbi
}
var file_infra_cros_recovery_tlw_models_proto_depIdxs = []int32{
	47, // 0: chromeos.recovery.RunRequest.timeout:type_name -> google.protobuf.Duration
	48, // 1: chromeos.recovery.CallBluetoothPeerRequest.args:type_name -> chromiumos.config.api.test.xmlrpc.Value
	48, // 2: chromeos.recovery.CallBluetoothPeerResponse.value:type_name -> chromiumos.config.api.test.xmlrpc.Value
	...
	45, // 8: chromeos.recovery.VersionResponse.value:type_name -> chromeos.recovery.VersionResponse.ValueEntry
	...
	49, // 17: chromeos.recovery.ServoHost.usb_drive:type_name -> chromiumos.test.lab.api.UsbDrive
	...
	46, // 41: chromeos.recovery.ChromeOS.ro_vpd_map:type_name -> chromeos.recovery.ChromeOS.RoVpdMapEntry
	50, // 42: chromeos.recovery.ChromeOS.cbi:type_name -> chromiumos.test.lab.api.Cbi
	37, // 43: chromeos.recovery.ChromeOS.cellular:type_name -> chromeos.recovery.Cellular
	30, // 44: chromeos.recovery.DevBoard.servo:type_name -> chromeos.recovery.ServoHost
	48, // 45: chromeos.recovery.CallServodRequest.args:type_name -> chromiumos.config.api.test.xmlrpc.Value
	47, // 46: chromeos.recovery.CallServodRequest.timeout:type_name -> google.protobuf.Duration
	48, // 47: chromeos.recovery.CallServodResponse.value:type_name -> chromiumos.config.api.test.xmlrpc.Value
