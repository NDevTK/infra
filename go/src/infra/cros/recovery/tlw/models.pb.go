...
func (ChromeOS_Cr50KeyEnv) EnumDescriptor() ([]byte, []int) {
	return file_infra_cros_recovery_tlw_models_proto_rawDescGZIP(), []int{23, 2}
}
...
func (ChromeOS_PeripheralWifiState) EnumDescriptor() ([]byte, []int) {
	return file_infra_cros_recovery_tlw_models_proto_rawDescGZIP(), []int{23, 3}
}
...
var file_infra_cros_recovery_tlw_models_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x64, 0x22, 0x41, 0x0a, 0x07, 0x42, 0x61, 0x74, 0x74, 0x65, 0x72, 0x79, 0x12, 0x36,
	...
	0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xed, 0x0c, 0x0a, 0x08, 0x43, 0x68, 0x72, 0x6f, 0x6d,
	...
	0x69, 0x2e, 0x43, 0x62, 0x69, 0x52, 0x03, 0x63, 0x62, 0x69, 0x1a, 0x3b, 0x0a, 0x0d, 0x52, 0x6f,
...
var file_infra_cros_recovery_tlw_models_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_infra_cros_recovery_tlw_models_proto_goTypes = []interface{}{
	...
	(*Battery)(nil),                   // 37: chromeos.recovery.Battery
	(*ChromeOS)(nil),                  // 38: chromeos.recovery.ChromeOS
	(*Android)(nil),                   // 39: chromeos.recovery.Android
	(*CopyRequest)(nil),               // 40: chromeos.recovery.CopyRequest
	(*CallServodRequest)(nil),         // 41: chromeos.recovery.CallServodRequest
	(*CallServodResponse)(nil),        // 42: chromeos.recovery.CallServodResponse
	nil,                               // 43: chromeos.recovery.VersionResponse.ValueEntry
	nil,                               // 44: chromeos.recovery.ChromeOS.RoVpdMapEntry
	(*durationpb.Duration)(nil),       // 45: google.protobuf.Duration
	(*xmlrpc.Value)(nil),              // 46: chromiumos.config.api.test.xmlrpc.Value
	(*api.UsbDrive)(nil),              // 47: chromiumos.test.lab.api.UsbDrive
	(*api.Cbi)(nil),                   // 48: chromiumos.test.lab.api.Cbi
}
var file_infra_cros_recovery_tlw_models_proto_depIdxs = []int32{
	45, // 0: chromeos.recovery.RunRequest.timeout:type_name -> google.protobuf.Duration
	46, // 1: chromeos.recovery.CallBluetoothPeerRequest.args:type_name -> chromiumos.config.api.test.xmlrpc.Value
	46, // 2: chromeos.recovery.CallBluetoothPeerResponse.value:type_name -> chromiumos.config.api.test.xmlrpc.Value
	...
	43, // 8: chromeos.recovery.VersionResponse.value:type_name -> chromeos.recovery.VersionResponse.ValueEntry
	...
	47, // 17: chromeos.recovery.ServoHost.usb_drive:type_name -> chromiumos.test.lab.api.UsbDrive
	...
	0,  // 25: chromeos.recovery.Battery.state:type_name -> chromeos.recovery.HardwareState
	11, // 26: chromeos.recovery.ChromeOS.power_supply_type:type_name -> chromeos.recovery.ChromeOS.PowerSupplyType
	12, // 27: chromeos.recovery.ChromeOS.cr50_phase:type_name -> chromeos.recovery.ChromeOS.Cr50Phase
	13, // 28: chromeos.recovery.ChromeOS.cr50_key_env:type_name -> chromeos.recovery.ChromeOS.Cr50KeyEnv
	25, // 29: chromeos.recovery.ChromeOS.audio:type_name -> chromeos.recovery.DUTAudio
	32, // 30: chromeos.recovery.ChromeOS.storage:type_name -> chromeos.recovery.Storage
	37, // 31: chromeos.recovery.ChromeOS.battery:type_name -> chromeos.recovery.Battery
	35, // 32: chromeos.recovery.ChromeOS.wifi:type_name -> chromeos.recovery.Wifi
	36, // 33: chromeos.recovery.ChromeOS.bluetooth:type_name -> chromeos.recovery.Bluetooth
	30, // 34: chromeos.recovery.ChromeOS.servo:type_name -> chromeos.recovery.ServoHost
	33, // 35: chromeos.recovery.ChromeOS.chameleon:type_name -> chromeos.recovery.Chameleon
	34, // 36: chromeos.recovery.ChromeOS.bluetooth_peers:type_name -> chromeos.recovery.BluetoothPeer
	22, // 37: chromeos.recovery.ChromeOS.wifi_routers:type_name -> chromeos.recovery.WifiRouterHost
	14, // 38: chromeos.recovery.ChromeOS.peripheral_wifi_state:type_name -> chromeos.recovery.ChromeOS.PeripheralWifiState
	21, // 39: chromeos.recovery.ChromeOS.rpm_outlet:type_name -> chromeos.recovery.RPMOutlet
	44, // 40: chromeos.recovery.ChromeOS.ro_vpd_map:type_name -> chromeos.recovery.ChromeOS.RoVpdMapEntry
	48, // 41: chromeos.recovery.ChromeOS.cbi:type_name -> chromiumos.test.lab.api.Cbi
	46, // 42: chromeos.recovery.CallServodRequest.args:type_name -> chromiumos.config.api.test.xmlrpc.Value
	45, // 43: chromeos.recovery.CallServodRequest.timeout:type_name -> google.protobuf.Duration
	46, // 44: chromeos.recovery.CallServodResponse.value:type_name -> chromiumos.config.api.test.xmlrpc.Value
