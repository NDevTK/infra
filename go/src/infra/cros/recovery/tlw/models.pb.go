...
var file_infra_cros_recovery_tlw_models_proto_rawDesc = []byte{
	...
	0x53, 0x10, 0x05, 0x22, 0x92, 0x01, 0x0a, 0x09, 0x43, 0x68, 0x61, 0x6d, 0x65, 0x6c, 0x65, 0x6f,
	...
	0x42, 0x52, 0x4f, 0x4b, 0x45, 0x4e, 0x10, 0x02, 0x22, 0x9a, 0x01, 0x0a, 0x0d, 0x42, 0x6c, 0x75,
...
var file_infra_cros_recovery_tlw_models_proto_depIdxs = []int32{
	...
	10, // 21: chromeos.recovery.BluetoothPeer.state:type_name -> chromeos.recovery.BluetoothPeer.State
	0,  // 22: chromeos.recovery.Wifi.state:type_name -> chromeos.recovery.HardwareState
	0,  // 23: chromeos.recovery.Bluetooth.state:type_name -> chromeos.recovery.HardwareState
	0,  // 24: chromeos.recovery.Battery.state:type_name -> chromeos.recovery.HardwareState
	11, // 25: chromeos.recovery.ChromeOS.power_supply_type:type_name -> chromeos.recovery.ChromeOS.PowerSupplyType
	12, // 26: chromeos.recovery.ChromeOS.cr50_phase:type_name -> chromeos.recovery.ChromeOS.Cr50Phase
	13, // 27: chromeos.recovery.ChromeOS.cr50_key_env:type_name -> chromeos.recovery.ChromeOS.Cr50KeyEnv
	25, // 28: chromeos.recovery.ChromeOS.audio:type_name -> chromeos.recovery.DUTAudio
	32, // 29: chromeos.recovery.ChromeOS.storage:type_name -> chromeos.recovery.Storage
	37, // 30: chromeos.recovery.ChromeOS.battery:type_name -> chromeos.recovery.Battery
	35, // 31: chromeos.recovery.ChromeOS.wifi:type_name -> chromeos.recovery.Wifi
	36, // 32: chromeos.recovery.ChromeOS.bluetooth:type_name -> chromeos.recovery.Bluetooth
	30, // 33: chromeos.recovery.ChromeOS.servo:type_name -> chromeos.recovery.ServoHost
	33, // 34: chromeos.recovery.ChromeOS.chameleon:type_name -> chromeos.recovery.Chameleon
	34, // 35: chromeos.recovery.ChromeOS.bluetooth_peers:type_name -> chromeos.recovery.BluetoothPeer
	22, // 36: chromeos.recovery.ChromeOS.wifi_routers:type_name -> chromeos.recovery.WifiRouterHost
	14, // 37: chromeos.recovery.ChromeOS.peripheral_wifi_state:type_name -> chromeos.recovery.ChromeOS.PeripheralWifiState
	21, // 38: chromeos.recovery.ChromeOS.rpm_outlet:type_name -> chromeos.recovery.RPMOutlet
	44, // 39: chromeos.recovery.ChromeOS.ro_vpd_map:type_name -> chromeos.recovery.ChromeOS.RoVpdMapEntry
	48, // 40: chromeos.recovery.ChromeOS.cbi:type_name -> chromiumos.test.lab.api.Cbi
	46, // 41: chromeos.recovery.CallServodRequest.args:type_name -> chromiumos.config.api.test.xmlrpc.Value
	45, // 42: chromeos.recovery.CallServodRequest.timeout:type_name -> google.protobuf.Duration
	46, // 43: chromeos.recovery.CallServodResponse.value:type_name -> chromiumos.config.api.test.xmlrpc.Value
