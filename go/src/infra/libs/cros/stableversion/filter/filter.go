...
// ByModel takes a stable version config description and a model and filters out the entries
// that match the model.
// sv cannot be nil. if model is "", then return everything.
func ByModel(sv *labPlatform.StableVersions, targetModel string) (*labPlatform.StableVersions, error) {
