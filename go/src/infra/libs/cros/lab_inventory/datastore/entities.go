...
func NewDeviceManualRepairRecordEntity(r *inv.DeviceManualRepairRecord) (*DeviceManualRepairRecordEntity, error) {
	...
	return &DeviceManualRepairRecordEntity{
		ID:          generateRepairRecordID(hostname, assetTag),
		Hostname:    hostname,
		AssetTag:    assetTag,
...
// Returns the predefined ID format of $hostname+$assetTag
func generateRepairRecordID(hostname string, assetTag string) string {
	return hostname + "-" + assetTag
}
