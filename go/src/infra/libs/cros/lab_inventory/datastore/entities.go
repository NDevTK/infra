...
func NewDeviceManualRepairRecordEntity(r *inv.DeviceManualRepairRecord) (*DeviceManualRepairRecordEntity, error) {
	...
	return &DeviceManualRepairRecordEntity{
		ID:          generateRepairRecordID(hostname, assetTag, createdTime),
		Hostname:    hostname,
		AssetTag:    assetTag,
...
func generateRepairRecordID(hostname string, assetTag string, createdTime string) string {
	return hostname + "-" + assetTag + "-" + createdTime
}
