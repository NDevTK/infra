...
func TestAddRecord(t *testing.T) {
	...
	ids1 := []string{
		generateRepairRecordID(record1.Hostname, record1.AssetTag, record1.CreatedTime.String()),
		generateRepairRecordID(record2.Hostname, record2.AssetTag, record2.CreatedTime.String()),
	}

	ids2 := []string{
		generateRepairRecordID(record3.Hostname, record3.AssetTag, record3.CreatedTime.String()),
		generateRepairRecordID(record4.Hostname, record4.AssetTag, record4.CreatedTime.String()),
	}
...
func TestUpdateRecord(t *testing.T) {
	...
	Convey("Update record in datastore", t, func() {
		Convey("Update existing record to datastore", func() {
			rec1ID := generateRepairRecordID(record1.Hostname, record1.AssetTag, record1.CreatedTime.String())
		...
		Convey("Update non-existent record in datastore", func() {
			rec2ID := generateRepairRecordID(record2.Hostname, record2.AssetTag, record2.CreatedTime.String())
		...
		Convey("Update multiple records to datastore", func() {
			rec3ID := generateRepairRecordID(record3.Hostname, record3.AssetTag, record3.CreatedTime.String())
			rec4ID := generateRepairRecordID(record4.Hostname, record4.AssetTag, record4.CreatedTime.String())
			req := []*inv.DeviceManualRepairRecord{record3, record4}
			res, err := AddDeviceManualRepairRecords(ctx, req)
			So(err, ShouldBeNil)
			So(res, ShouldNotBeNil)
		...
		Convey("Update record without ID to datastore", func() {
			rec5ID := generateRepairRecordID(record5.Hostname, record5.AssetTag, record5.CreatedTime.String())
