	...
	Convey("Get device manual repair record from datastore by property name", t, func() {
		Convey("Get repair record by Hostname", func() {
			...
			for _, r := range res {
				...
				So(r.Entity.Hostname, ShouldEqual, record1.GetHostname())
				So(r.Record.GetHostname(), ShouldEqual, record1.GetHostname())
				So([]string{record1.GetRepairState().String(), record2.GetRepairState().String()}, ShouldContain, r.Entity.RepairState)
				So([]string{record1.GetRepairState().String(), record2.GetRepairState().String()}, ShouldContain, r.Record.GetRepairState().String())
				So([]string{record1.GetAssetTag(), record3.GetAssetTag()}, ShouldContain, r.Record.GetAssetTag())
				So([]string{record1.GetAssetTag(), record3.GetAssetTag()}, ShouldContain, r.Record.GetAssetTag())
			}
		})
		Convey("Get repair record by AssetTag", func() {
			...
			for _, r := range res {
				...
				So(r.Entity.Hostname, ShouldEqual, record1.GetHostname())
				So(r.Record.GetHostname(), ShouldEqual, record1.GetHostname())
				So(r.Entity.AssetTag, ShouldEqual, record1.GetAssetTag())
				So(r.Record.GetAssetTag(), ShouldEqual, record1.GetAssetTag())
				So([]string{record1.GetRepairState().String(), record2.GetRepairState().String()}, ShouldContain, r.Entity.RepairState)
				So([]string{record1.GetRepairState().String(), record2.GetRepairState().String()}, ShouldContain, r.Record.GetRepairState().String())
			}
		})
		Convey("Get repair record by RepairState", func() {
			...
			So(res[0].Record.GetHostname(), ShouldEqual, record2.GetHostname())
			So(res[0].Entity.AssetTag, ShouldEqual, record2.GetAssetTag())
			So(res[0].Record.GetAssetTag(), ShouldEqual, record2.GetAssetTag())
			So(res[0].Entity.RepairState, ShouldEqual, record2.GetRepairState().String())
			So(res[0].Record.GetRepairState(), ShouldEqual, record2.GetRepairState())
		})
	})
}
