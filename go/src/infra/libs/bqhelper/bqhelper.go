/*
Package bqhelper implements an interface for a bigquery client.

It also exposing methods for interacting with a client.

It was created to make it easier to write unit tests for code that uses
bigquery.
*/
package bqhelper
...
// biquery is an interface for a bigquery client.
