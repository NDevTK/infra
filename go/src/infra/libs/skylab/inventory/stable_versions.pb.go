...
func (*StableVersions) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*StableVersion) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func init() { proto.RegisterFile("stable_versions.proto", fileDescriptor0) }
