...
func (Server_Status) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
func (Server_Role) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 1} }

// NEXT TAG: 9
type Server struct {
	Hostname    *string                                                   `protobuf:"bytes,1,req,name=hostname" json:"hostname,omitempty"`
	Cname       *string                                                   `protobuf:"bytes,2,opt,name=cname" json:"cname,omitempty"`
	Environment *chrome_chromeos_infra_skylab_proto_inventory.Environment `protobuf:"varint,3,req,name=environment,enum=chrome.chromeos_infra.skylab.proto.inventory.Environment" json:"environment,omitempty"`
...
func (m *Server) GetEnvironment() chrome_chromeos_infra_skylab_proto_inventory.Environment {
...
func (*Attributes) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
