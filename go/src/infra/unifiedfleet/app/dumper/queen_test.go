...
// testingContext sets up an environment with fake GAE services
func testingContext() context.Context {
	return gaetesting.TestingContextWithAppID("dev~infra-unified-fleet-system")
}
...
func TestPushToDroneQueenNamesapces(t *testing.T) {
	...
	addMachineLSE(browserCtx, "browser")
