...
// ConfigBundleEntity is a datastore entity that tConfigBundles ConfigBundle.
...
func newConfigBundleEntity(ctx context.Context, pm proto.Message) (ufsds.FleetEntity, error) {
