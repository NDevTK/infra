...
func TestGetPublicChromiumTestStatus(t *testing.T) {
	...
	Convey("Check Fleet Policy For Tests", t, func() {
		Convey("happy path", func() {
			...
			So(err, ShouldBeNil)
			So(res.Status, ShouldEqual, api.CheckFleetTestsPolicyResponse_OK)
		})
		Convey("Private board", func() {
			...
			res, err := tf.Fleet.CheckFleetTestsPolicy(ctx, req)
			So(err, ShouldBeNil)
			So(res.Status, ShouldEqual, api.CheckFleetTestsPolicyResponse_NOT_A_PUBLIC_BOARD)
		})
		Convey("Private model", func() {
			...
			res, err := tf.Fleet.CheckFleetTestsPolicy(ctx, req)
			So(err, ShouldBeNil)
			So(res.Status, ShouldEqual, api.CheckFleetTestsPolicyResponse_NOT_A_PUBLIC_MODEL)
		})
		Convey("Non allowlisted image", func() {
			...
			res, err := tf.Fleet.CheckFleetTestsPolicy(ctx, req)
			So(err, ShouldBeNil)
			So(res.Status, ShouldEqual, api.CheckFleetTestsPolicyResponse_NOT_A_PUBLIC_IMAGE)
		})
