...
var file_infra_unifiedfleet_app_config_config_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0xc0, 0x08, 0x0a, 0x06, 0x43, 0x6f, 0x6e,
	...
	0x69, 0x7a, 0x65, 0x64, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xae, 0x02, 0x0a, 0x0f,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x68, 0x65, 0x65, 0x74, 0x49, 0x64, 0x22, 0x57, 0x0a, 0x06,
...
var file_infra_unifiedfleet_app_config_config_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_infra_unifiedfleet_app_config_config_proto_goTypes = []interface{}{
	...
	(*UserAgent)(nil),                         // 3: ufs.config.UserAgent
	(*OSNetworkConfig_OSNetworkTopology)(nil), // 4: ufs.config.OSNetworkConfig.OSNetworkTopology
}
var file_infra_unifiedfleet_app_config_config_proto_depIdxs = []int32{
	...
	3, // 2: ufs.config.Config.clients:type_name -> ufs.config.UserAgent
	4, // 3: ufs.config.OSNetworkConfig.cros_network_topology:type_name -> ufs.config.OSNetworkConfig.OSNetworkTopology
