...
type PubSub struct {
	...
	// Batch size for batching requests. HaRT services have been known to fail for
	// batch_size > 100. Changing this value might disable HaRT updates.
...
func (x *PubSub) GetBatchSize() int64 {
	if x != nil {
		return x.BatchSize
	}
	return 0
