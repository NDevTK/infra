...
type DeviceUnderTest struct {
	...
	WifiSecret *WifiSecret `protobuf:"bytes,12,opt,name=wifi_secret,json=wifiSecret,proto3" json:"wifi_secret,omitempty"`
}
...
func (x *DeviceUnderTest) GetWifiSecret() *WifiSecret {
	if x != nil {
		return x.WifiSecret
	}
	return nil
...
type WifiSecret struct {
	...
	// A wifi secret can be assigned to multiple DUT pools or a UFS zones, so the
	// DUTs in the designated pools/zones have the wifi secret as the default.
	DutPools []string `protobuf:"bytes,3,rep,name=dut_pools,json=dutPools,proto3" json:"dut_pools,omitempty"` // The DUT pools using this wifi secret.
	Zones    []string `protobuf:"bytes,4,rep,name=zones,proto3" json:"zones,omitempty"`                       // The UFS zone using this wifi secret.
}

func (x *WifiSecret) Reset() {
	*x = WifiSecret{}
	if protoimpl.UnsafeEnabled {
		mi := &file_infra_unifiedfleet_api_v1_models_chromeos_lab_device_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WifiSecret) Descriptor() ([]byte, []int) {
	return file_infra_unifiedfleet_api_v1_models_chromeos_lab_device_proto_rawDescGZIP(), []int{4}
}
...
func (x *WifiSecret) GetDutPools() []string {
	if x != nil {
		return x.DutPools
	}
	return nil
...
func (x *WifiSecret) GetZones() []string {
	if x != nil {
		return x.Zones
	}
	return nil
...
var file_infra_unifiedfleet_api_v1_models_chromeos_lab_device_proto_rawDesc = []byte{
	...
	0x6e, 0x42, 0x08, 0x0a, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x22, 0x8f, 0x08, 0x0a, 0x0f,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x69, 0x76, 0x65, 0x12, 0x54, 0x0a, 0x0b, 0x77, 0x69,
	0x66, 0x69, 0x5f, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x6f, 0x6d, 0x65, 0x6f, 0x73, 0x2e, 0x6c, 0x61, 0x62, 0x2e, 0x57, 0x69, 0x66, 0x69, 0x53, 0x65,
	0x63, 0x72, 0x65, 0x74, 0x52, 0x0a, 0x77, 0x69, 0x66, 0x69, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74,
	...
	,
	...
	0x61, 0x62, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x6f, 0x52, 0x06, 0x73, 0x65, 0x72, 0x76, 0x6f, 0x73,
	0x12, 0x40, 0x0a, 0x03, 0x72, 0x70, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e,
	...
	0x70, 0x6d, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x22, 0x66, 0x0a, 0x08, 0x44, 0x65, 0x76, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x12, 0x44, 0x0a, 0x05, 0x73, 0x65, 0x72, 0x76, 0x6f, 0x18, 0x01, 0x20,
	...
	0x72, 0x76, 0x6f, 0x52, 0x05, 0x73, 0x65, 0x72, 0x76, 0x6f, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x6f,
	0x6f, 0x6c, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x70, 0x6f, 0x6f, 0x6c, 0x73,
	0x22, 0x7f, 0x0a, 0x0a, 0x57, 0x69, 0x66, 0x69, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x1d,
	...
	0x0a, 0x09, 0x64, 0x75, 0x74, 0x5f, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x08, 0x64, 0x75, 0x74, 0x50, 0x6f, 0x6f, 0x6c, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x7a,
	0x6f, 0x6e, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x7a, 0x6f, 0x6e, 0x65,
...
var file_infra_unifiedfleet_api_v1_models_chromeos_lab_device_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_infra_unifiedfleet_api_v1_models_chromeos_lab_device_proto_goTypes = []interface{}{
	...
	(*WifiSecret)(nil),             // 5: unifiedfleet.api.v1.models.chromeos.lab.WifiSecret
	nil,                            // 6: unifiedfleet.api.v1.models.chromeos.lab.DeviceUnderTest.RoVpdMapEntry
	(*ChromeOSDeviceID)(nil),       // 7: unifiedfleet.api.v1.models.chromeos.lab.ChromeOSDeviceID
	(*manufacturing.ConfigID)(nil), // 8: unifiedfleet.api.v1.models.chromeos.manufacturing.ConfigID
	(*device.ConfigId)(nil),        // 9: unifiedfleet.api.v1.models.chromeos.device.ConfigId
	(*Peripherals)(nil),            // 10: unifiedfleet.api.v1.models.chromeos.lab.Peripherals
	(*License)(nil),                // 11: unifiedfleet.api.v1.models.chromeos.lab.License
	(*ModemInfo)(nil),              // 12: unifiedfleet.api.v1.models.chromeos.lab.ModemInfo
	(*SIMInfo)(nil),                // 13: unifiedfleet.api.v1.models.chromeos.lab.SIMInfo
	(*api.Cbi)(nil),                // 14: chromiumos.test.lab.api.Cbi
...
var file_infra_unifiedfleet_api_v1_models_chromeos_lab_device_proto_depIdxs = []int32{
	7,  // 0: unifiedfleet.api.v1.models.chromeos.lab.ChromeOSDevice.id:type_name -> unifiedfleet.api.v1.models.chromeos.lab.ChromeOSDeviceID
	8,  // 1: unifiedfleet.api.v1.models.chromeos.lab.ChromeOSDevice.manufacturing_id:type_name -> unifiedfleet.api.v1.models.chromeos.manufacturing.ConfigID
	9,  // 2: unifiedfleet.api.v1.models.chromeos.lab.ChromeOSDevice.device_config_id:type_name -> unifiedfleet.api.v1.models.chromeos.device.ConfigId
	...
	10, // 5: unifiedfleet.api.v1.models.chromeos.lab.DeviceUnderTest.peripherals:type_name -> unifiedfleet.api.v1.models.chromeos.lab.Peripherals
	...
	11, // 7: unifiedfleet.api.v1.models.chromeos.lab.DeviceUnderTest.licenses:type_name -> unifiedfleet.api.v1.models.chromeos.lab.License
	12, // 8: unifiedfleet.api.v1.models.chromeos.lab.DeviceUnderTest.modeminfo:type_name -> unifiedfleet.api.v1.models.chromeos.lab.ModemInfo
	13, // 9: unifiedfleet.api.v1.models.chromeos.lab.DeviceUnderTest.siminfo:type_name -> unifiedfleet.api.v1.models.chromeos.lab.SIMInfo
	6,  // 10: unifiedfleet.api.v1.models.chromeos.lab.DeviceUnderTest.ro_vpd_map:type_name -> unifiedfleet.api.v1.models.chromeos.lab.DeviceUnderTest.RoVpdMapEntry
	14, // 11: unifiedfleet.api.v1.models.chromeos.lab.DeviceUnderTest.cbi:type_name -> chromiumos.test.lab.api.Cbi
	5,  // 12: unifiedfleet.api.v1.models.chromeos.lab.DeviceUnderTest.wifi_secret:type_name -> unifiedfleet.api.v1.models.chromeos.lab.WifiSecret
...
func file_infra_unifiedfleet_api_v1_models_chromeos_lab_device_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_infra_unifiedfleet_api_v1_models_chromeos_lab_device_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
