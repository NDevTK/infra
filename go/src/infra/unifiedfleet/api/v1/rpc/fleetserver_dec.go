...
func (s *DecoratedFleet) RenameMachineLSE(ctx context.Context, req *RenameMachineLSERequest) (rsp *emptypb.Empty, err error) {
	if s.Prelude != nil {
		var newCtx context.Context
...
func (s *DecoratedFleet) RenameAsset(ctx context.Context, req *RenameAssetRequest) (rsp *emptypb.Empty, err error) {
	if s.Prelude != nil {
		var newCtx context.Context
