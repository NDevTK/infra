...
// CompareRejectedDimensions calls pretty.Compare() after dropping some default
// keys from the rejected dimensions.
//
// Use this function to check expectations on rejected dimensions.
func CompareRejectedDimensions(want, got map[string]string) string {
