...
func (r *TaskSet) verdict() test_platform.TaskState_Verdict {
	...
	for _, t := range r.testRuns {
		switch t.Verdict() {
		case test_platform.TaskState_VERDICT_PASSED, test_platform.TaskState_VERDICT_NO_VERDICT:
			continue
		case test_platform.TaskState_VERDICT_PASSED_ON_RETRY:
			v = test_platform.TaskState_VERDICT_PASSED_ON_RETRY
		case test_platform.TaskState_VERDICT_UNSPECIFIED, test_platform.TaskState_VERDICT_FAILED:
