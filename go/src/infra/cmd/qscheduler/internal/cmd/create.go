...
var Create = &subcommands.Command{
	...
	CommandRun: func() subcommands.CommandRun {
		...
		c.Flags.BoolVar(&c.disablePreemption, "disable-preemption", false, "Disable preemption.")
...
func (c *createRun) Run(a subcommands.Application, args []string, env subcommands.Env) int {
	...
	req := &qscheduler.CreateSchedulerPoolRequest{
		PoolId: poolID,
		Config: &protos.SchedulerConfig{Labels: c.labels, DisablePreemption: c.disablePreemption},
	}
