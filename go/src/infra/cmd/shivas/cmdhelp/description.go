...
`
	...
	SwitchFileText string = `[JSON/MCSV Mode] Path to a file containing switch specification.
...
switch-3,rack-2,hello-2,Apple Pro Power
...
Partial updates a rpm by parameters. Only specified parameters will be udpated in the rpm.`
	...
	RPMFileText string = `[JSON/MCSV Mode] Path to a file containing rpm specification.
...
rpm-3,chromeos2,22:22:22:22:22:22,13,hello-2,Apple Pro Power
