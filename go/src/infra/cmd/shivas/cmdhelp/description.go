...
shivas update dut -name chromeos6-rack3-row2-host1 -deploy-only
...
shivas update dut -name chromeos6-rack3-row2-host1 -rpm chromeos6-row11_12-rack24-rpm1 -rpm-outlet .A22
