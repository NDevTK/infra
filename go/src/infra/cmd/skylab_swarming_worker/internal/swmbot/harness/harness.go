...
func (u labelUpdater) update(dutID string, oldLabels *inventory.SchedulableLabels, newLabels *inventory.SchedulableLabels) error {
...
func (u labelUpdater) makeRequest(dutID string, oldLabels *inventory.SchedulableLabels, newLabels *inventory.SchedulableLabels) (*fleet.UpdateDutLabelsRequest, error) {
	nl, err := proto.Marshal(newLabels)
	if err != nil {
		return nil, err
	}
	ol, err := proto.Marshal(oldLabels)
	if err != nil {
		return nil, err
	}
