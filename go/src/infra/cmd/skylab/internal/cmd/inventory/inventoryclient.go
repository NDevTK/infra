...
// InventoryClient defines the common interface for the inventory client used by
...
func NewInventoryClient(hc *http.Client, env site.Environment, version2 bool) InventoryClient {
	if version2 {
