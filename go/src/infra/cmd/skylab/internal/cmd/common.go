...
// testTaskRequest creates a new swarming task request for a skylab test.
func testTaskRequest(taskName string, tags []string, slices []*swarming.SwarmingRpcsTaskSlice) *swarming.SwarmingRpcsNewTaskRequest {
