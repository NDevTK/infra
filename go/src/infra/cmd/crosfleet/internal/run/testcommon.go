...
const (
	...
	PublicChromiumTestsAuthGroup = "public-chromium-in-chromeos-builders"
)
...
func validTestNamesForPublicChromiumTests() []string {
	return []string{"tast.lacros"}
}

func validBoardNamesForPublicChromiumTests() []string {
	return []string{"eve", "kevin"}
}

func validModelsForPublicChromiumTests() []string {
	return []string{"eve", "kevin"}
}

func contains(paramArr []string, param string) bool {
