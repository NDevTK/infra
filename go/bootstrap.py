...
TOOLSET_VERSIONS = {
    'default': '1.20.1',  # used on dev workstations and most try builders
    'legacy': '1.20.1',  # used on OSX amd64 CI and prod builders
    'bleeding_edge':
        '1.20.1',  # used on most CI and prod and some try builders
}
