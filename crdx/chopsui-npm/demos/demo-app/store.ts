...
import {compose, createStore, Action} from 'redux';
...
// TODO: figure out what to use instead of any, any.
// https://github.com/reduxjs/redux/blob/master/index.d.ts#L305
//export const store = createStore<AppState, TodoAppAction, {}, {}>(todoApp, composeEnhancers);
