...
SPECS.update({
    s.spec.tag: s for s in assert_sorted(
        ...
        UniversalSource('contextvars', '2.4', pyversions=['py3']),
        ...
        UniversalSource('immutables', '0.19', pyversions=['py3']),
...
SPECS.update({
    s.spec.tag: s for s in assert_sorted('Universal', *[
        ...
        Universal('aiocontextvars', '0.2.2', pyversions=['py3']),
        ...
        Universal('dataclasses', '0.8', pyversions=['py3']),
