...
_BUILDINFRA_BUILDBUCKET = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='hostname', full_name='buildbucket.v2.BuildInfra.Buildbucket.hostname', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='service_config_revision', full_name='buildbucket.v2.BuildInfra.Buildbucket.service_config_revision', index=1,
