...
_USERQUOTACONFIG_PAYER = _descriptor.EnumDescriptor(
  name='Payer',
  full_name='cv.config.UserQuotaConfig.Payer',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='PAYER_CL_OWNER', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='PAYER_RUN_TRIGGERER', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_USERQUOTACONFIG_PAYER)
...
_CONFIGGROUP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='user_quota_config', full_name='cv.config.ConfigGroup.user_quota_config', index=6,
...
_QUOTAPOLICY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='user', full_name='cv.config.QuotaPolicy.user', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cria_group', full_name='cv.config.QuotaPolicy.cria_group', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_active_runs', full_name='cv.config.QuotaPolicy.max_active_runs', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_active_tryjobs', full_name='cv.config.QuotaPolicy.max_active_tryjobs', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='apply_to', full_name='cv.config.QuotaPolicy.apply_to',
...
_USERQUOTACONFIG = _descriptor.Descriptor(
  name='UserQuotaConfig',
  full_name='cv.config.UserQuotaConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='policies', full_name='cv.config.UserQuotaConfig.policies', index=0,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='payer', full_name='cv.config.UserQuotaConfig.payer', index=1,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='include_optional', full_name='cv.config.UserQuotaConfig.include_optional', index=2,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONFIGGROUP.fields_by_name['user_quota_config'].message_type = _USERQUOTACONFIG
...
_QUOTAPOLICY.oneofs_by_name['apply_to'].fields.append(
  _QUOTAPOLICY.fields_by_name['user'])
_QUOTAPOLICY.fields_by_name['user'].containing_oneof = _QUOTAPOLICY.oneofs_by_name['apply_to']
_QUOTAPOLICY.oneofs_by_name['apply_to'].fields.append(
  _QUOTAPOLICY.fields_by_name['cria_group'])
_QUOTAPOLICY.fields_by_name['cria_group'].containing_oneof = _QUOTAPOLICY.oneofs_by_name['apply_to']
_USERQUOTACONFIG.fields_by_name['policies'].message_type = _QUOTAPOLICY
_USERQUOTACONFIG.fields_by_name['payer'].enum_type = _USERQUOTACONFIG_PAYER
_USERQUOTACONFIG_PAYER.containing_type = _USERQUOTACONFIG
...
DESCRIPTOR.message_types_by_name['UserQuotaConfig'] = _USERQUOTACONFIG
...
UserQuotaConfig = _reflection.GeneratedProtocolMessageType('UserQuotaConfig', (_message.Message,), {
  'DESCRIPTOR' : _USERQUOTACONFIG,
  '__module__' : 'go.chromium.org.luci.cv.api.config.v2.config_pb2'
  # @@protoc_insertion_point(class_scope:cv.config.UserQuotaConfig)
  })
_sym_db.RegisterMessage(UserQuotaConfig)
