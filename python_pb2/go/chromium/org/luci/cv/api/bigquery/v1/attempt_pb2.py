...
_GERRITCHANGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='is_owner_bot', full_name='bigquery.GerritChange.is_owner_bot', index=8,
...
_ATTEMPT.fields_by_name['actual_start_time'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
