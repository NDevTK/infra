...
_CONSTRAINTS = _descriptor.Descriptor(
  name='Constraints',
  full_name='buildbucket.Constraints',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='pools', full_name='buildbucket.Constraints.pools', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='service_accounts', full_name='buildbucket.Constraints.service_accounts', index=1,
...
_BUCKET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='shadow', full_name='buildbucket.Bucket.shadow', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='constraints', full_name='buildbucket.Bucket.constraints', index=5,
...
_BUCKET.fields_by_name['constraints'].message_type = _CONSTRAINTS
...
Constraints = _reflection.GeneratedProtocolMessageType('Constraints', (_message.Message,), {
  ...
  '__module__' : 'go.chromium.org.luci.buildbucket.proto.project_config_pb2'
  # @@protoc_insertion_point(class_scope:buildbucket.Constraints)
  })
