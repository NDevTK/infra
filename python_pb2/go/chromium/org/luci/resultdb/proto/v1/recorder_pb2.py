...
_MARKINVOCATIONSUBMITTEDREQUEST = _descriptor.Descriptor(
  name='MarkInvocationSubmittedRequest',
  full_name='luci.resultdb.v1.MarkInvocationSubmittedRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='invocation', full_name='luci.resultdb.v1.MarkInvocationSubmittedRequest.invocation', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['MarkInvocationSubmittedRequest'] = _MARKINVOCATIONSUBMITTEDREQUEST
...
MarkInvocationSubmittedRequest = _reflection.GeneratedProtocolMessageType('MarkInvocationSubmittedRequest', (_message.Message,), {
  'DESCRIPTOR' : _MARKINVOCATIONSUBMITTEDREQUEST,
  '__module__' : 'go.chromium.org.luci.resultdb.proto.v1.recorder_pb2'
  # @@protoc_insertion_point(class_scope:luci.resultdb.v1.MarkInvocationSubmittedRequest)
  })
_sym_db.RegisterMessage(MarkInvocationSubmittedRequest)
...
_MARKINVOCATIONSUBMITTEDREQUEST.fields_by_name['invocation']._options = None
...
_RECORDER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='MarkInvocationSubmitted',
    full_name='luci.resultdb.v1.Recorder.MarkInvocationSubmitted',
    index=5,
    containing_service=None,
    input_type=_MARKINVOCATIONSUBMITTEDREQUEST,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
