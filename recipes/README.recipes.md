...
#### **class [InfraCIPDApi](/recipes/recipe_modules/infra_cipd/api.py#9)([RecipeApi][recipe_engine/wkt/RecipeApi]):**
...
&mdash; **def [build](/recipes/recipe_modules/infra_cipd/api.py#68)(self):**

Builds packages.

&emsp; **@contextlib.contextmanager**<br>&mdash; **def [context](/recipes/recipe_modules/infra_cipd/api.py#43)(self, path_to_repo, goos, goarch):**

Returns context for cross-compiling Go code.

&mdash; **def [tags](/recipes/recipe_modules/infra_cipd/api.py#24)(self, git_repo_url, revision):**

Returns tags to be attached to uploaded CIPD packages.

&mdash; **def [test](/recipes/recipe_modules/infra_cipd/api.py#75)(self, skip_if_cross_compiling=False):**

Tests previously built packages integrity.

&mdash; **def [upload](/recipes/recipe_modules/infra_cipd/api.py#83)(self, tags, step_test_data=None):**
