...
#### **class [RecipeAutorollerApi](/recipes/recipe_modules/recipe_autoroller/api.py#132)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [roll\_projects](/recipes/recipe_modules/recipe_autoroller/api.py#136)(self, projects, db_gcs_bucket):**
