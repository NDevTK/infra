...
def DetectionRate(summary_stats):
  """The ratio that Predator do give results."""
  return Percent(summary_stats.true_positives + summary_stats.false_positives +
                 summary_stats.true_negatives,
                 summary_stats.total_examples - summary_stats.untriaged -
                 summary_stats.unsure)
