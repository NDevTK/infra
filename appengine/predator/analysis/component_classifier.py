...
class ComponentClassifier(object):
  ...
  def ClassifyFilePath(self, file_path):
    ...
    for component in self.components:
      ...
      if match:
        components[component.component_name] = directory.count('/')

    # Returns components with longest path.
    return (max(components, key=lambda component: components[component])
