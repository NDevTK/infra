...
KNOWN_INFRA_STEPS_NAMES = [
    # Intentionally not add "analyze", because flakes are quite rare and most
    # likely caused by some breakage in the tree, see http://crbug.com/725802.
    'bot_update',
    'commit-git-patch',
  ...
  def post(self):
    ...
    for step in steps:
      ...
      if (step_name.startswith('[swarming]') or
          step_name.startswith('test_pre_run') or
