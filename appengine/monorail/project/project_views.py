...
class MemberView(object):
  ...
  def __init__(
    ...
    project_commitments, effective_ids=None, acexclusion=False,
    ...
    Args:
      ...
      acexclusion: True when this member should not be in autocomplete.
    ...
    self.ac_include = ezt.boolean(not acexclusion)
