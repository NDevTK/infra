...
class ConfigService(object):
  ...
  def UpdateIssueTemplateDef(
      ...
      owner_defaults_to_members=None, component_required=None, owner_id=None,
      labels=None, component_ids=None, admin_ids=None, field_values=None):
    """Update and existing issue template definition with the given info.
    ...
    if owner_defaults_to_members is not None:
      new_values['owner_defaults_to_members'] = bool(owner_defaults_to_members)
