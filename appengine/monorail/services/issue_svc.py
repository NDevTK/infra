...
ISSUEUPDATE_COLS = [
    ...
    'added_user_id', 'removed_user_id', 'custom_field_name', 'added_component_id', 'removed_component_id']
...
class IssueService(object):
  ...
  def _UnpackAmendment(self, amendment_row):
    ...
    (_id, _issue_id, comment_id, field_name,
     ...
     custom_field_name, added_component_id, removed_component_id) = amendment_row
    ...
    for (field, _custom_name), sorted_amendments in sorted(fields_dict.items()):
      ...
      for amendment in sorted_amendments:
        ...
        if amendment.added_component_ids:
          new_amendment.added_component_ids.extend(amendment.added_component_ids)
        if amendment.removed_component_ids:
          new_amendment.removed_component_ids.extend(amendment.removed_component_ids)          
    ...
    for amendment in comment.amendments:
      ...
      if (amendment.get_assigned_value('newvalue') is not None and
        ...
        amendment_rows.append((
            ...
            None, None, amendment.custom_field_name, None, None))
      ...
      for removed_user_id in amendment.removed_user_ids:
        amendment_rows.append((
            comment.issue_id, comment_id, field_enum, None, None,
            None, removed_user_id, amendment.custom_field_name, None, None))
      for added_component_id in amendment.added_component_ids:
        amendment_rows.append((
            comment.issue_id, comment_id, field_enum, None, None,
            None, None, amendment.custom_field_name, added_component_id, None)) 
      for removed_component_id in amendment.removed_component_ids:
        amendment_rows.append((
            comment.issue_id, comment_id, field_enum, None, None,
            None, None, amendment.custom_field_name, None, removed_component_id))                    
