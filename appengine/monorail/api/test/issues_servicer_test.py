...
class IssuesServicerTest(unittest.TestCase):
  ...
  def testGetIssue_Moved(self):
    ...
    # We need an issue with a higher local id than the original location of
    # the moved issue.
    higher_issue = fake.MakeTestIssue(789, 500, 'sum', 'New', 111L,
        issue_id=1020)
    self.services.issue.TestAddIssue(issue)
    self.services.issue.TestAddIssue(higher_issue)
