...
def ConvertIssue(issue, users_by_id, related_refs, config):
  ...
  # TODO(crbug.com/monorail/5857): Remove this conditional
  # after underlying source of negative attachment counts
  # has been resolved and database has been repaired.
