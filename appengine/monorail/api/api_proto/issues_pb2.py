...
_AREISSUESSTARREDREQUEST = _descriptor.Descriptor(
  name='AreIssuesStarredRequest',
  full_name='monorail.AreIssuesStarredRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_AREISSUESSTARREDRESPONSE = _descriptor.Descriptor(
  name='AreIssuesStarredResponse',
  full_name='monorail.AreIssuesStarredResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='issue_ids', full_name='monorail.AreIssuesStarredResponse.issue_ids', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_AREISSUESSTARREDRESPONSE.fields_by_name['issue_ids'].message_type = api_dot_api__proto_dot_common__pb2._ISSUEREF
...
DESCRIPTOR.message_types_by_name['AreIssuesStarredRequest'] = _AREISSUESSTARREDREQUEST
DESCRIPTOR.message_types_by_name['AreIssuesStarredResponse'] = _AREISSUESSTARREDRESPONSE
...
AreIssuesStarredRequest = _reflection.GeneratedProtocolMessageType('AreIssuesStarredRequest', (_message.Message,), dict(
  DESCRIPTOR = _AREISSUESSTARREDREQUEST,
  __module__ = 'api.api_proto.issues_pb2'
  # @@protoc_insertion_point(class_scope:monorail.AreIssuesStarredRequest)
  ))
_sym_db.RegisterMessage(AreIssuesStarredRequest)

AreIssuesStarredResponse = _reflection.GeneratedProtocolMessageType('AreIssuesStarredResponse', (_message.Message,), dict(
  DESCRIPTOR = _AREISSUESSTARREDRESPONSE,
  __module__ = 'api.api_proto.issues_pb2'
  # @@protoc_insertion_point(class_scope:monorail.AreIssuesStarredResponse)
  ))
_sym_db.RegisterMessage(AreIssuesStarredResponse)
...
_ISSUES = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='AreIssuesStarred',
    full_name='monorail.Issues.AreIssuesStarred',
    index=8,
    containing_service=None,
    input_type=_AREISSUESSTARREDREQUEST,
    output_type=_AREISSUESSTARREDRESPONSE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='ListComments',
