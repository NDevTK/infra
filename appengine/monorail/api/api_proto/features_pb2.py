...
_GETHOTLISTSTARCOUNTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hotlist', full_name='monorail.GetHotlistStarCountRequest.hotlist', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STARHOTLISTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hotlist', full_name='monorail.StarHotlistRequest.hotlist', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETHOTLISTSTARCOUNTREQUEST.fields_by_name['hotlist'].message_type = api_dot_api__proto_dot_common__pb2._HOTLISTREF
_STARHOTLISTREQUEST.fields_by_name['trace'].message_type = api_dot_api__proto_dot_common__pb2._REQUESTTRACE
_STARHOTLISTREQUEST.fields_by_name['hotlist'].message_type = api_dot_api__proto_dot_common__pb2._HOTLISTREF
