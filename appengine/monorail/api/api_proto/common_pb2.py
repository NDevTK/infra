...
_HOTLISTREF = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='owner_ref', full_name='monorail.HotlistRef.owner_ref', index=1,
...
_HOTLISTREF.fields_by_name['owner_ref'].message_type = _USERREF
