...
_REMOVEHOTLISTEDITORSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='monorail.v1.RemoveHotlistEditorsRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\340A\002\372A\027\n\025api.crbug.com/Hotlist'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='users', full_name='monorail.v1.RemoveHotlistEditorsRequest.users', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REMOVEHOTLISTEDITORSREQUEST.fields_by_name['parent']._options = None
_REMOVEHOTLISTEDITORSREQUEST.fields_by_name['users']._options = None
