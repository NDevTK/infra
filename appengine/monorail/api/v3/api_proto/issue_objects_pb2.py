...
_COMMENT_ATTACHMENT.fields_by_name['state'].enum_type = _STATE
_COMMENT_ATTACHMENT.containing_type = _COMMENT
_COMMENT_AMENDMENT.containing_type = _COMMENT
_COMMENT.fields_by_name['state'].enum_type = _STATE
...
_ISSUE.fields_by_name['state'].enum_type = _STATE
