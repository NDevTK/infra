...
export class MrComment extends LitElement {
      ...
      <div
        ...
        ${_shouldOfferCommentOptions(this.quickMode, this.comment) ? html`
          <div class="comment-options">
            <mr-dropdown
              .items="${this._commentOptions(this.comment)}"
              icon="more_vert"
            ></mr-dropdown>
          </div>
        ` : ''}
  ...
  _commentOptions(comment) {
    ...
    if (comment.canDelete) {
      ...
      options.push({
        text: text,
        handler: _deleteComment.bind(comment),
      });
    }
    if (comment.canFlag) {
      ...
      options.push({
        text: text,
        handler: _flagComment.bind(comment),
      });
    }
    return options;
  }
