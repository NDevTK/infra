...
describe('mr-star-button', () => {
  ...
  // TODO(juliacordero) : Repair
  it('_starredIssues changes displayed icon', async () => {
    element.issueRef = {projectName: 'proj', localId: 1};

    sinon.stub(element, 'stateChanged').callsFake(function fakeStateChanged() {
    ...
    element._starredIssues.delete(issueRefToString(element.issueRef));
