...
import { GoogleIssueTrackerIssue } from './federated.js';
...
describe('renderMarkdown', () => {
  ...
  describe('can render links', () => {
    ...
    it('correctly renders monorail user links', () => {
      const actual = renderMarkdown('[person@google.com](bugs.chromium.org/u/person@google.com)');
      const expected = `<p><span class="annotated-link"><a title="" ` +
      `href="bugs.chromium.org/u/person@google.com"><span class="material-icons ` +
      `link">link</span>person@google.com</a><span class="tooltip">Link destination: ` +
      `bugs.chromium.org/u/person@google.com</span></span></p>\n`
      assert.equal(actual, expected)
    });
