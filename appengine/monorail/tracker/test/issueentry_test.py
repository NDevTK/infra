...
class IssueEntryTest(unittest.TestCase):
  ...
  def testAssertBasePermission(self):
    ...
    self.assertRaises(
        ...
        self.servlet.AssertBasePermission,
        mr,
    )
    mr = testing_helpers.MakeMonorailRequest(
        path="/p/proj/issues/entry",
  ...
  def testDiscardUnusedTemplateLabelPrefixes(self):
    ...
    self.assertEqual(
        labels, issueentry._DiscardUnusedTemplateLabelPrefixes(labels))
  ...
  def testGatherPageData(self):
    ...
    self.services.user.GetUser(mox.IgnoreArg(),
                               mox.IgnoreArg()).MultipleTimes().AndReturn(user)
    self.mox.ReplayAll()
  ...
  def testGatherPageData_Approvals(self):
    ...
    self.services.config.StoreConfig(mr.cnxn, config)
    template = tracker_pb2.TemplateDef()
    template.phases = [tracker_pb2.Phase(phase_id=1, rank=4, name="Stable")]
  ...
  def testGatherPageData_DefaultOwnerAvailability(self):
    ...
    self.assertEqual(
        page_data["owner_avail_message_short"], "User never visited")
  ...
  def testGatherPageData_MembersOnlyTemplatesExcluded(
      self, mockUserIsInProject):
  ...
  def testProcessFormData_RejectPlacedholderSummary(self):
    ...
    self.servlet.PleaseCorrect(
        ...
        initial_owner="",
        initial_status="New",
        initial_summary="Enter one-line summary",
        initial_hotlists="",
        labels=[],
        template_name="rutabaga",
    )
  ...
  def testProcessFormData_RejectNonexistentHotlist(self):
    ...
    entered_hotlists = "H3"
    post_data = fake.PostData(
        hotlists=[entered_hotlists], template_name=["rutabaga"])
    self.mox.StubOutWithMock(self.servlet, "PleaseCorrect")
    self.servlet.PleaseCorrect(
        mr,
        component_required=None,
        ...
        initial_status="",
        initial_summary="",
        initial_hotlists=entered_hotlists,
        labels=[],
        template_name="rutabaga",
    )
    self.mox.ReplayAll()
  ...
  def testProcessFormData_TemplateNameMissing(self, _create_task_mock):
    ...
    post_data = fake.PostData(
        summary=["fake summary"], comment=["fake comment"], status=["New"])
