...
def UpdateAnalysisDataPoints(analysis_urlsafe_key, commit_position, revision,
                             build_url, try_job_url, swarming_task_output):
  ...
  Args:
    ...
    build_url (str): The url to the build at commit_position, if applicable.
        Mutually exclusive with try_job_url.
    try_job_url (str): The url to the try job that compiled commit_position, if
        applicable. Mutually exclusive with build_url.
