...
Automatically posted by the findit-for-me app (https://goo.gl/Ot9f7N)."""
  ...
  @mock.patch.object(flake_issue_util, '_GetAndUpdateMergedIssue')
  def testGetFlakeGroupsForActionsOnBugs(self, mock_get_merged_issue):
    ...
    flake3 = self._CreateFlake('s3', 'suite1.t3', 'suite1.t3')
    occurrences3 = [
    ...
    flake4 = self._CreateFlake('s2', 'suite2.t4', 'suite2.t4')
    occurrences4 = [
    ...
    flake_group1 = flake_issue_util.FlakeGroupByOccurrences(
        flake1, occurrences1)
    flake_group1.AddFlake(flake2, occurrences2)
    ...
    flake_group4.AddFlake(flake6, occurrences6)
