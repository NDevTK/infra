...
from services import monorail_helper
...
class MonorailHelperTest(unittest.TestCase):
  @mock.patch.object(
      monorail_helper, 'GetGTestComponent', return_value='component')
  ...
  def testGetGTestComponent(self, get_component_fn, get_location_fn):
    ...
    self.assertEqual('chromium>foo',
                     monorail_helper.GetGTestComponent(
                         test_name, results))
  ...
  def testGetNearestComponentForPath(self, url_fn):
    ...
    self.assertEqual('chromium>foo',
                     monorail_helper.GetNearestComponentForPath(path))
