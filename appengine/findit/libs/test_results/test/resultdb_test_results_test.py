    ...
    self.assertEqual(
        rdb_test_results.test_results, {
            u"ninja://gpu:gl_tests/SharedImageTest.Basic": {
                ...
                "classified_results": {
                    test_result_pb2.TestStatus.PASS: 1,
                    test_result_pb2.TestStatus.CRASH: 1,
                }
            },
            u"ninja://gpu:gl_tests/SharedImageTest.Basic1": {
                ...
                "classified_results": {
                    test_result_pb2.TestStatus.FAIL: 2,
                }
            },
            u"ninja://gpu:gl_tests/SharedImageTest.Basic2": {
                ...
                "num_unexpected_results": 1,
                "classified_results": {
                    test_result_pb2.TestStatus.ABORT: 1,
                }
            },
            u"ninja://gpu:gl_tests/SharedImageTest.Basic3": {
                ...
                "classified_results": {
                    test_result_pb2.TestStatus.SKIP: 1,
                }
            },
            u"ninja://gpu:gl_tests/SharedImageTest.Basic4": {
                ...
                "num_unexpected_results": 1,
                "classified_results": {
                    test_result_pb2.TestStatus.STATUS_UNSPECIFIED: 1,
                }
            },
        })
