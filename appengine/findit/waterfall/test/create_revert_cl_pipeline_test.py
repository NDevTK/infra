...
class CreateRevertCLPipelineTest(wf_testcase.WaterfallTestCase):
  ...
  def setUp(self):
    ...
    self.culprit_code_review_url = 'https://codereview.chromium.org/20001'
    ...
    self.cl_info = ClInfo(self.culprit_code_review_url)
    self.cl_info.commits.append(
  ...
  def testRevertCLSucceed(self, mock_fn, *_):
    ...
    mock_fn.return_value = self.cl_info
