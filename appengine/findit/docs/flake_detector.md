...
* At least 3 unreported flake occurrences of type 'cq false rejection' or 'cq
  retry with patch' that are associated with different CLs or at least 1
  unreported CI flake occurrences within the past 24 hours.
