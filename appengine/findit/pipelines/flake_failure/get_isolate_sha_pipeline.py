...
from services.parameters import GetIsolateShaForCommitPositionParameters
from services.parameters import RunFlakeTryJobParameters
from waterfall import build_util
from waterfall import swarming_util


class _GetIsolateShaForBuildParameters(StructuredObject):
...
class _GetIsolateShaForBuildPipeline(SynchronousPipeline):
  input_type = _GetIsolateShaForBuildParameters
...
class GetIsolateShaForCommitPositionPipeline(GeneratorPipeline):
  ...
  def RunImpl(self, parameters):
    ...
    if earliest_containing_build.commit_position == commit_position:
      ...
      get_build_sha_parameters = _GetIsolateShaForBuildParameters(
          master_name=master_name,
          builder_name=builder_name,
          build_number=earliest_containing_build.build_number,
          step_name=step_name)
      yield _GetIsolateShaForBuildPipeline(get_build_sha_parameters)
    else:
