...
_GITILES_HOST = 'chromium.googlesource.com'
_GITILES_PROJECT = 'chromium/src'
_GITILES_REF = 'refs/heads/master'
...
class GetIsolateShaForTargetPipeline(SynchronousPipeline):
  ...
  def RunImpl(self, parameters):
    ...
    assert isolated_target, 'IsolatedTarget was deleted unexpectedly!'
  ...
  def RunImpl(self, parameters):
    ...
    targets = (
        IsolatedTarget.FindIsolateAtOrAfterCommitPositionByMaster(
            master_name, builder_name, _GITILES_HOST, _GITILES_PROJECT,
            _GITILES_REF, target_name, commit_position))
