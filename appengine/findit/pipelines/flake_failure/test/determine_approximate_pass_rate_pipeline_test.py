...
class DetermineApproximatePassRatePipelineTest(WaterfallTestCase):
  ...
  def testDetermineApproximatePassRateFirstRunNewDataPoint(self):
    ...
    flake_swarming_task_output = RunFlakeSwarmingTaskOutput(
        ...
        completed_time=completed_time, started_time=started_time,
        has_valid_artifact=True, task_id='task_id')
  ...
  def testDetermineApproximatePassRateMaximumIterationsPerDataPointReached(
    ...
    flake_swarming_task_output = RunFlakeSwarmingTaskOutput(
        error=None, pass_count=incoming_pass_count, iterations=iterations,
        started_time=started_time, completed_time=completed_time,
        has_valid_artifact=has_valid_artifact, task_id=task_id)
  ...
  def testDetermineApproximatePassRateTestDoesNotExist(self, *_):
    ...
    flake_swarming_task_output = RunFlakeSwarmingTaskOutput(
        error=None, pass_count=incoming_pass_count, iterations=iterations,
        task_id=task_id, started_time=started_time,
        completed_time=completed_time,
        has_valid_artifact=has_valid_artifact)
  ...
  def testUpdateFlakeAnalysisDataPointsPipeline(self, mocked_update):
    ...
    swarming_task_output = RunFlakeSwarmingTaskOutput(
        error=None, pass_count=5, iterations=10,
        started_time=datetime(2018, 1, 1, 0, 0, 0),
        completed_time=datetime(2018, 1, 1, 1, 0, 0),
        has_valid_artifact=True, task_id='task_id')
