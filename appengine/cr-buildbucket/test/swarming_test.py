...
class TaskDefTest(BaseTest):
  ...
  def test_properties(self):
    ...
    actual = bbutil.struct_to_dict(swarming._compute_properties(build))
  ...
  def test_overall(self):
    ...
    expected_input_properties = test_util.ununicode(
        api_common.properties_to_json(swarming._compute_properties(build))
    )
