...
# class ValidateProjectIDTest(testing.AppengineTestCase):

#   def test_valid(self):
#     errors.validate_project_id('chromium')

#   @parameterized.expand([
#       ('a/b',),
#       ('a:b',),
#   ])
#   def test_invalid(self, project_id):
#     with self.assertRaises(errors.InvalidInputError):
#       errors.validate_project_id(project_id)
