...
class ConfigTest(testing.AppengineTestCase):
  ...
  def test_validate_buildbucket_cfg_swarming(self):
    ...
    print mock_flatten_builder_with_cloned_args.call_args_list
    mock_flatten_builder_with_cloned_args.assert_any_call(
