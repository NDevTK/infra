...
class TagIndex(ndb.Model):
  ...
  Entity key:
    ...
    BuildIndex has no parent.
  """

  # entries is a superset of all builds that have the tag equal to the id of
  # this entity.
  #
  # It may contain references to non-existent builds or builds that do not
  # actually have this tag; such builds must be ignored.
  #
  # It is sorted by build id.
  entries = ndb.StructuredProperty(TagIndexEntry, repeated=True, indexed=False)
