...
class TagIndex(ndb.Model):
  ...
  SHARD_COUNT = 32  # This value MUST NOT decrease.
  ...
  def make_key(cls, shard_index, tag):
    """Returns a TagIndex entity id.

    If shard_index is None, returns id of a a random shard.
    """
    assert not tag.startswith(':')
    if shard_index is None:
      shard_index = cls.random_shard_index()
