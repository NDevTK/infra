...
_NETWORKDEVICE_TYPEID = _descriptor.EnumDescriptor(
  name='TypeId',
  full_name='monarch.prodx.NetworkDevice.TypeId',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_NETWORKDEVICE = _descriptor.Descriptor(
  name='NetworkDevice',
  full_name='monarch.prodx.NetworkDevice',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='proxy_environment', full_name='monarch.prodx.NetworkDevice.proxy_environment', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='acquisition_name', full_name='monarch.prodx.NetworkDevice.acquisition_name', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pop', full_name='monarch.prodx.NetworkDevice.pop', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='alertable', full_name='monarch.prodx.NetworkDevice.alertable', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='realm', full_name='monarch.prodx.NetworkDevice.realm', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='asn', full_name='monarch.prodx.NetworkDevice.asn', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metro', full_name='monarch.prodx.NetworkDevice.metro', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='role', full_name='monarch.prodx.NetworkDevice.role', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hostname', full_name='monarch.prodx.NetworkDevice.hostname', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vendor', full_name='monarch.prodx.NetworkDevice.vendor', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hostgroup', full_name='monarch.prodx.NetworkDevice.hostgroup', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='proxy_zone', full_name='monarch.prodx.NetworkDevice.proxy_zone', index=11,
...
NetworkDevice = _reflection.GeneratedProtocolMessageType('NetworkDevice', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:monarch.prodx.NetworkDevice)
  ))
