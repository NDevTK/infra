...
while [ ! -f "$_testenv_gclient_root/.gclient" ] || \
    [ ! -d "$_testenv_gclient_root/infra/cipd/gcloud/platform/google_appengine" ]; do
...
_testenv_ae_root="$_testenv_gclient_root"/infra/cipd/gcloud/platform/google_appengine
