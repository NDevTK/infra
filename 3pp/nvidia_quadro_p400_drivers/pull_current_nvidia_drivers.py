...
"""Pulls the most recent NVIDIA Quadro P400 GPU driver and uploads them to CIPD.
...
# for the Quadro P400, and observing the network calls that are made when the
...
SERIES_ID = 73  # Quadro Series.
PRODUCT_ID = 844  # Quadro P400.
...
#         "IsDC": "1",
#         "IsActive": "1",
#         "ReleaseDateTime": "Tue April 16, 2024",
#         "DetailsURL": "https://www.nvidia.com/download/driverResults.aspx/224020/en-us/",
#         "DownloadURL": "https://us.download.nvidia.com/Windows/Quadro_Certified/552.22/552.22-quadro-rtx-desktop-notebook-win10-win11-64bit-international-dch-whql.exe",
#         "DownloadURLFileSize": "483 MB",
