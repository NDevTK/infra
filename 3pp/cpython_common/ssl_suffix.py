...
def _linux_find_load_verify_locations_kwargs():
  ...
  # Borrowed from https://github.com/golang/go/blob/master/src/crypto/x509/root_linux.go#L9
  ca_files = [
  ...
  # Borrowed from https://github.com/golang/go/blob/master/src/crypto/x509/root_unix.go#L16
  ca_paths = [
